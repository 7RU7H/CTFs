### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.10.66.205
---
**Details**: **tech-detect:google-font-api**  matched at http://10.10.66.205

**Protocol**: HTTP

**Full URL**: http://10.10.66.205

**Timestamp**: Tue Jan 10 19:31:55 +0000 GMT 2023
...
Date: Tue, 10 Jan 2023 19:31:54 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.3319.102 Safari/537.36' 'http://10.10.66.205'
```
---
