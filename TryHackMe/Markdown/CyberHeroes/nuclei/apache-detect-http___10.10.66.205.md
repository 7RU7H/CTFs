### Apache Detection (apache-detect) found on http://10.10.66.205
---
**Details**: **apache-detect**  matched at http://10.10.66.205

**Protocol**: HTTP

**Full URL**: http://10.10.66.205

**Timestamp**: Tue Jan 10 19:31:54 +0000 GMT 2023
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://10.10.66.205'
```
---
