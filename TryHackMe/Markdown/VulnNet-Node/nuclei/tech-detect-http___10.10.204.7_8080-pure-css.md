### Wappalyzer Technology Detection (tech-detect:pure-css) found on http://10.10.204.7:8080
---
**Details**: **tech-detect:pure-css**  matched at http://10.10.204.7:8080

**Protocol**: HTTP

**Full URL**: http://10.10.204.7:8080

**Timestamp**: Sat Jan 28 21:40:19 +0000 GMT 2023
...
Date: Sat, 28 Jan 2023 21:40:18 GMT
Etag: W/"1daf-dPXia8DLlOwYnTXebWSDo/Cj9Co"
Set-Cookie: session=eyJ1c2VybmFtZSI6Ikd1ZXN0IiwiaXNHdWVzdCI6dHJ1ZSwiZW5jb2RpbmciOiAidXRmLTgifQ%3D%3D; Max-Age=1200; Path=/; Expires=Sat, 28 Jan 2023 22:00:18 GMT; HttpOnly
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2117.157 Safari/537.36' 'http://10.10.204.7:8080'
```
---
