### Microsoft Exchange Server Detect (ms-exchange-server) found on https://10.10.252.86
---
**Details**: **ms-exchange-server**  matched at https://10.10.252.86

**Protocol**: HTTP

**Full URL**: https://10.10.252.86/owa/auth/logon.aspx

**Timestamp**: Thu Apr 6 22:59:35 +0100 BST 2023
...
Date: Thu, 06 Apr 2023 21:59:34 GMT
Expires: -1
Pragma: no-cache
Request-Id: 63e030bd-2d23-4b7a-87d2-59201f534748
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.137 Safari/4E423F' 'https://10.10.252.86/owa/auth/logon.aspx'
```
---
