### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on https://10.10.252.86
---
**Details**: **http-missing-security-headers:permissions-policy**  matched at https://10.10.252.86
