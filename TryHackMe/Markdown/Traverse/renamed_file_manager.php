                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <hr />
                                    <div class="mb-3">
                                        <label for="fm_usr" class="pb-2"><?php echo 'username'; ?></label>
                                        <input type="text" class="form-control" value ="admin" id="fm_usr" name="fm_usr" required autofocus>
                                    </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a target="_blank" class="float-right text-muted">My File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a target="_blank" class="float-right text-muted">My File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Test File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with My File Manager">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'My File Manager';      $tr['en']['AppTitle']           = 'File Manager';
