### Apache Detection (apache-detect) found on http://10.10.75.48
---
**Details**: **apache-detect**  matched at http://10.10.75.48

**Protocol**: HTTP

**Full URL**: http://10.10.75.48

**Timestamp**: Tue Apr 18 11:00:39 +0100 BST 2023
...
Date: Tue, 18 Apr 2023 10:00:39 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML like Gecko) Chrome/44.0.2403.155 Safari/537.36' 'http://10.10.75.48'
```
---
