### WAF Detection (waf-detect:apachegeneric) found on http://10.10.75.48
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.10.75.48

**Protocol**: HTTP

**Full URL**: http://10.10.75.48/

**Timestamp**: Tue Apr 18 11:01:28 +0100 BST 2023
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.10.75.48' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2762.73 Safari/537.36' 'http://10.10.75.48/'
```
---
