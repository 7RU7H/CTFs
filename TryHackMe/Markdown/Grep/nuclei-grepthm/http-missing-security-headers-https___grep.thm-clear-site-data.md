### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on grep.thm

----
**Details**: **http-missing-security-headers:clear-site-data** matched at grep.thm
