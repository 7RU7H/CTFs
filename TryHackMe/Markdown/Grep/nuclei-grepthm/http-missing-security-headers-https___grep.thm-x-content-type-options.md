### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on grep.thm

----
**Details**: **http-missing-security-headers:x-content-type-options** matched at grep.thm
