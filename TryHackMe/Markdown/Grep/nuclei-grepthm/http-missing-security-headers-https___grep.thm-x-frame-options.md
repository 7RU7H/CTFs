### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on grep.thm

----
**Details**: **http-missing-security-headers:x-frame-options** matched at grep.thm
