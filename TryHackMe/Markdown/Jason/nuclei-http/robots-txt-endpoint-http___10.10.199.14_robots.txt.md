### robots.txt endpoint prober (robots-txt-endpoint) found on http://10.10.199.14
---
**Details**: **robots-txt-endpoint**  matched at http://10.10.199.14

**Protocol**: HTTP

**Full URL**: http://10.10.199.14/robots.txt

**Timestamp**: Sun Jan 8 19:43:32 +0000 GMT 2023
...
Date: Sun, 08 Jan 2023 19:43:33 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.4; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2225.0 Safari/537.36' 'http://10.10.199.14/robots.txt'
```
---
