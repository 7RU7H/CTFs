### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on myblog.thm:9007

----
**Details**: **http-missing-security-headers:permissions-policy** matched at myblog.thm:9007
