### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.10.72.190
---
**Details**: **tech-detect:google-font-api**  matched at http://10.10.72.190
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'http://10.10.72.190'
```
---
