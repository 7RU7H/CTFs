### WAF Detection (waf-detect:apachegeneric) found on internal.thm

----
**Details**: **waf-detect:apachegeneric** matched at internal.thm

**Protocol**: HTTP

**Full URL**: http://internal.thm/wordpress/

**Timestamp**: Sun May 12 11:04:01 +0100 BST 2024
...
Date: Sun, 12 May 2024 10:04:02 GMT
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: internal.thm' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 11_1) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/9.1.2 Safari/605.1.15' 'http://internal.thm/wordpress/'
```
