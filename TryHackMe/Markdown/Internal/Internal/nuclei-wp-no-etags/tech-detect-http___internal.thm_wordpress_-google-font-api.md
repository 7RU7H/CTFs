### Wappalyzer Technology Detection (tech-detect:google-font-api) found on internal.thm

----
**Details**: **tech-detect:google-font-api** matched at internal.thm

**Protocol**: HTTP

**Full URL**: http://internal.thm/wordpress/

**Timestamp**: Sun May 12 11:03:30 +0100 BST 2024
...
Date: Sun, 12 May 2024 10:03:30 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 12_2_1) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.3 Safari/605.1.15' 'http://internal.thm/wordpress/'
```
