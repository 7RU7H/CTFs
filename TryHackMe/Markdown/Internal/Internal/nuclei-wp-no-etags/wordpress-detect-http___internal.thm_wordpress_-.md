### WordPress Detect (wordpress-detect:version_by_js) found on internal.thm

----
**Details**: **wordpress-detect:version_by_js** matched at internal.thm

**Protocol**: HTTP

**Full URL**: http://internal.thm/wordpress/

**Timestamp**: Sun May 12 11:04:00 +0100 BST 2024
...
| Authors | pdteam, daffainfo, ricardomaia, topscoder, adamcrosser |
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0' 'http://internal.thm/wordpress/'
```
