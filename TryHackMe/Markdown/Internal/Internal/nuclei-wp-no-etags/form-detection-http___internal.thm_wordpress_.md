### Form Detection (form-detection) found on internal.thm

----
**Details**: **form-detection** matched at internal.thm

**Protocol**: HTTP

**Full URL**: http://internal.thm/wordpress/

**Timestamp**: Sun May 12 11:03:33 +0100 BST 2024
...
Date: Sun, 12 May 2024 10:03:35 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; CrOS x86_64 14541.0.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36' 'http://internal.thm/wordpress/'
```
