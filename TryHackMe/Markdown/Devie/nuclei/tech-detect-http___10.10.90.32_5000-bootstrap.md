### Wappalyzer Technology Detection (tech-detect:bootstrap) found on http://10.10.90.32:5000
---
**Details**: **tech-detect:bootstrap**  matched at http://10.10.90.32:5000

**Protocol**: HTTP

**Full URL**: http://10.10.90.32:5000

**Timestamp**: Sat Apr 1 20:03:34 +0100 BST 2023
...
Date: Sat, 01 Apr 2023 19:03:34 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; OpenBSD i386) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.125 Safari/537.36' 'http://10.10.90.32:5000'
```
---
