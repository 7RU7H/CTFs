### Wappalyzer Technology Detection (tech-detect:php) found on 10.10.86.204:8080

----
**Details**: **tech-detect:php** matched at 10.10.86.204:8080

**Protocol**: HTTP

**Full URL**: http://10.10.86.204:8080

**Timestamp**: Wed Jan 10 17:22:23 +0000 GMT 2024
...
Date: Wed, 10 Jan 2024 17:22:17 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'http://10.10.86.204:8080'
```
