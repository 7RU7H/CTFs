### Joomla! Panel (joomla-panel) found on http://10.10.0.9
---
**Details**: **joomla-panel**  matched at http://10.10.0.9

**Protocol**: HTTP

**Full URL**: http://10.10.0.9/administrator/

**Timestamp**: Fri Sep 23 18:45:55 +0100 BST 2022
...
Date: Fri, 23 Sep 2022 17:45:54 GMT
Expires: Wed, 17 Aug 2005 00:00:00 GMT
Last-Modified: Fri, 23 Sep 2022 17:45:55 GMT
Pragma: no-cache
Server: Apache/2.4.6 (CentOS) PHP/5.6.40
Set-Cookie: 2b01af51830ca9615359108de04d9ca1=kgl9vlasljlmcsketvbdrqpad5; path=/; HttpOnly
...
<body class="site com_login view-login layout-default task- itemid- ">
	...
	<fieldset class="loginform">
		...
		<input type="hidden" name="51212c70ffd61686565546f8283dc0c8" value="1" />	</fieldset>
</form>
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.47 Safari/537.36' 'http://10.10.0.9/administrator/'
```
---
