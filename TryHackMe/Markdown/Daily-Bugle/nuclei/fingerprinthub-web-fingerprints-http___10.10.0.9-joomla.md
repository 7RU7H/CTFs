### FingerprintHub Technology Fingerprint (fingerprinthub-web-fingerprints:joomla) found on http://10.10.0.9
---
**Details**: **fingerprinthub-web-fingerprints:joomla**  matched at http://10.10.0.9

**Protocol**: HTTP

**Full URL**: http://10.10.0.9

**Timestamp**: Fri Sep 23 18:45:46 +0100 BST 2022
...
Last-Modified: Fri, 23 Sep 2022 17:45:45 GMT
Pragma: no-cache
Server: Apache/2.4.6 (CentOS) PHP/5.6.40
Set-Cookie: eaa83fe8b963ab08ce9ab7d4a798de05=hqu1vg1anipck7v57he42e0fs4; path=/; HttpOnly
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.124 Safari/537.36' 'http://10.10.0.9'
```
---
