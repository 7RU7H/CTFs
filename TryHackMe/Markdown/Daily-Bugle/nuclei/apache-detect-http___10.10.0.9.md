### Apache Detection (apache-detect) found on http://10.10.0.9
---
**Details**: **apache-detect**  matched at http://10.10.0.9
...
Set-Cookie: eaa83fe8b963ab08ce9ab7d4a798de05=i2ebva7hp62eb53c5pmbhn63u7; path=/; HttpOnly
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36' 'http://10.10.0.9'
```
---
