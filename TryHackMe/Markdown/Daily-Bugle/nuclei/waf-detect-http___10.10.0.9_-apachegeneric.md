### WAF Detection (waf-detect:apachegeneric) found on http://10.10.0.9
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.10.0.9

**Protocol**: HTTP

**Full URL**: http://10.10.0.9/

**Timestamp**: Fri Sep 23 18:46:14 +0100 BST 2022
...
Last-Modified: Fri, 23 Sep 2022 17:46:13 GMT
Pragma: no-cache
Server: Apache/2.4.6 (CentOS) PHP/5.6.40
Set-Cookie: eaa83fe8b963ab08ce9ab7d4a798de05=b9f15rsgakji22o0u0mc3hsm34; path=/; HttpOnly
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.10.0.9' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2226.0 Safari/537.36' 'http://10.10.0.9/'
```
---
