### Nginx version detect (nginx-version) found on http://10.10.146.5

----
**Details**: **nginx-version** matched at http://10.10.146.5

**Protocol**: HTTP

**Full URL**: http://10.10.146.5

**Timestamp**: Sun Aug 13 15:00:20 +0100 BST 2023
...
Date: Sun, 13 Aug 2023 14:00:20 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2226.0 Safari/537.36' 'http://10.10.146.5'
```
