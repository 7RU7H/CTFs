### WAF Detection (waf-detect:apachegeneric) found on http://10.10.183.138
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.10.183.138

**Protocol**: HTTP

**Full URL**: http://10.10.183.138/

**Timestamp**: Thu Feb 2 11:06:10 +0000 GMT 2023
...
Date: Thu, 02 Feb 2023 11:06:10 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.10.183.138' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://10.10.183.138/'
```
---
