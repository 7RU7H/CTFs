...
(function($){
    ...
    $.widget('ui.checkBox', {
        ...
        _create: function(){
            ...
            if (opts.hideInput) {
                ...
                if(opts.addVisualElement){
                    this.visualElement = $('<span />').addClass('ui-'+this.inputType);
                    if (this.element.hasClass('switch')) {
                        this.visualElement.addClass('switch');
                    }
        ...
        _addEvents: function(){
            ...
            if(opts.addVisualElement){
                this.visualElement.bind('click.checkBox', function(e){
        ...
        destroy: function(onlyCss){
            ...
            if (this.visualElement && this.visualElement.addClass) {
