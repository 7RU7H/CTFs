### Wappalyzer Technology Detection (tech-detect:nginx) found on http://10.10.132.79/

----
**Details**: **tech-detect:nginx** matched at http://10.10.132.79/

**Protocol**: HTTP

**Full URL**: http://10.10.132.79/

**Timestamp**: Sat Jul 1 18:23:26 +0100 BST 2023
...
Date: Sat, 01 Jul 2023 17:22:39 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://10.10.132.79/'
```
