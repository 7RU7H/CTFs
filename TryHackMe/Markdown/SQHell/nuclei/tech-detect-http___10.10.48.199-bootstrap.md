### Wappalyzer Technology Detection (tech-detect:bootstrap) found on http://10.10.48.199
---
**Details**: **tech-detect:bootstrap**  matched at http://10.10.48.199

**Protocol**: HTTP

**Full URL**: http://10.10.48.199

**Timestamp**: Sat Feb 18 15:04:07 +0000 GMT 2023
...
Date: Sat, 18 Feb 2023 15:04:06 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2866.71 Safari/537.36' 'http://10.10.48.199'
```
---
