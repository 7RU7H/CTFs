### Nginx version detect (nginx-version) found on http://10.10.112.119
---
**Details**: **nginx-version**  matched at http://10.10.112.119

**Protocol**: HTTP

**Full URL**: http://10.10.112.119

**Timestamp**: Thu Apr 6 13:50:19 +0100 BST 2023
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.124 Safari/537.36' 'http://10.10.112.119'
```
---
