### Apache HTTP Server Test Page (default-apache-test-page) found on https://10.10.193.71
---
**Details**: **default-apache-test-page**  matched at https://10.10.193.71

**Protocol**: HTTP

**Full URL**: https://10.10.193.71

**Timestamp**: Thu Jan 19 12:00:13 +0000 GMT 2023
...
Date: Thu, 19 Jan 2023 12:00:12 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.47 Safari/537.36' 'https://10.10.193.71'
```
---
