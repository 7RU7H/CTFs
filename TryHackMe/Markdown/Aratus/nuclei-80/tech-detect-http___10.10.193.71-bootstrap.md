### Wappalyzer Technology Detection (tech-detect:bootstrap) found on http://10.10.193.71
---
**Details**: **tech-detect:bootstrap**  matched at http://10.10.193.71

**Protocol**: HTTP

**Full URL**: http://10.10.193.71

**Timestamp**: Thu Jan 19 11:53:19 +0000 GMT 2023
...
Date: Thu, 19 Jan 2023 11:53:19 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2762.73 Safari/537.36' 'http://10.10.193.71'
```
---
