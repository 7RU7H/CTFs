### Apache HTTP Server Test Page (default-apache-test-page) found on http://10.10.193.71
---
**Details**: **default-apache-test-page**  matched at http://10.10.193.71
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://10.10.193.71'
```
---
