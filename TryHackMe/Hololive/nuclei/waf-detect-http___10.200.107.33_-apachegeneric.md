### WAF Detection (waf-detect:apachegeneric) found on http://10.200.107.33
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.200.107.33

**Protocol**: HTTP

**Full URL**: http://10.200.107.33/

**Timestamp**: Mon Nov 7 12:00:32 +0000 GMT 2022
...
Date: Mon, 07 Nov 2022 12:00:32 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.200.107.33' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2226.0 Safari/537.36' 'http://10.200.107.33/'
```
---
