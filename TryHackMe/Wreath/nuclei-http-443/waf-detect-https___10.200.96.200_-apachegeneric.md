### WAF Detection (waf-detect:apachegeneric) found on https://10.200.96.200/

----
**Details**: **waf-detect:apachegeneric** matched at https://10.200.96.200/

**Protocol**: HTTP

**Full URL**: https://10.200.96.200/

**Timestamp**: Tue Aug 22 11:47:40 +0100 BST 2023
...
Date: Tue, 22 Aug 2023 10:47:36 GMT
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.200.96.200' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2226.0 Safari/537.36' 'https://10.200.96.200/'
```
