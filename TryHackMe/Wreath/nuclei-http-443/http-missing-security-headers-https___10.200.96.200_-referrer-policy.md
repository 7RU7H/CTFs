### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on https://10.200.96.200/

----
**Details**: **http-missing-security-headers:referrer-policy** matched at https://10.200.96.200/
