### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on https://10.200.96.200/

----
**Details**: **http-missing-security-headers:x-content-type-options** matched at https://10.200.96.200/
