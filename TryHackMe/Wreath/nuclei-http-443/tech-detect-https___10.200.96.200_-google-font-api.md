### Wappalyzer Technology Detection (tech-detect:google-font-api) found on https://10.200.96.200/

----
**Details**: **tech-detect:google-font-api** matched at https://10.200.96.200/

**Protocol**: HTTP

**Full URL**: https://10.200.96.200/

**Timestamp**: Tue Aug 22 11:45:49 +0100 BST 2023
...
Date: Tue, 22 Aug 2023 10:45:44 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.124 Safari/537.36' 'https://10.200.96.200/'
```
