### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on https://10.200.96.200/

----
**Details**: **http-missing-security-headers:permissions-policy** matched at https://10.200.96.200/
