### Wappalyzer Technology Detection (tech-detect:bootstrap) found on http://10.129.233.229
---
**Details**: **tech-detect:bootstrap**  matched at http://10.129.233.229
...
Date: Fri, 24 Feb 2023 12:16:33 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.1 Safari/537.36' 'http://10.129.233.229'
```
---
