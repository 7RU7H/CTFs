### WAF Detection (waf-detect:apachegeneric) found on http://10.129.233.229
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.129.233.229

**Protocol**: HTTP

**Full URL**: http://10.129.233.229/

**Timestamp**: Fri Feb 24 12:17:27 +0000 GMT 2023
...
Date: Fri, 24 Feb 2023 12:17:27 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.233.229' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2049.0 Safari/537.36' 'http://10.129.233.229/'
```
---
