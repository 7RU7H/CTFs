### Wappalyzer Technology Detection (tech-detect:font-awesome) found on http://hat-valley.htb

----
**Details**: **tech-detect:font-awesome** matched at http://hat-valley.htb
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.137 Safari/4E423F' 'http://hat-valley.htb'
```
