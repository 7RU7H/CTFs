### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on http://hat-valley.htb

----
**Details**: **http-missing-security-headers:clear-site-data** matched at http://hat-valley.htb
