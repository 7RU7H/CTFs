### Microsoft IIS version detect (microsoft-iis-version) found on 10.129.9.205

----
**Details**: **microsoft-iis-version** matched at 10.129.9.205

**Protocol**: HTTP

**Full URL**: http://10.129.9.205

**Timestamp**: Fri Feb 2 10:27:02 +0000 GMT 2024
...
Date: Fri, 02 Feb 2024 10:27:01 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2656.18 Safari/537.36' 'http://10.129.9.205'
```
