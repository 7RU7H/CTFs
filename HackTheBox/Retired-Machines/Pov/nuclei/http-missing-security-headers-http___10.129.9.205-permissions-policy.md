### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on 10.129.9.205

----
**Details**: **http-missing-security-headers:permissions-policy** matched at 10.129.9.205
