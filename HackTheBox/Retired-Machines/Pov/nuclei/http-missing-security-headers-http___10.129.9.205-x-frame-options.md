### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on 10.129.9.205

----
**Details**: **http-missing-security-headers:x-frame-options** matched at 10.129.9.205
