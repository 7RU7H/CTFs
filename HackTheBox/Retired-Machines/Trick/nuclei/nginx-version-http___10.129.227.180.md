### Nginx version detect (nginx-version) found on http://10.129.227.180
---
**Details**: **nginx-version**  matched at http://10.129.227.180

**Protocol**: HTTP

**Full URL**: http://10.129.227.180

**Timestamp**: Thu Apr 27 09:35:01 +0100 BST 2023
...
Date: Thu, 27 Apr 2023 08:35:00 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2224.3 Safari/537.36' 'http://10.129.227.180'
```
---
