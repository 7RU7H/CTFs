### Google API Key (google-api-key) found on http://dynamicdns.htb

----
**Details**: **google-api-key** matched at http://dynamicdns.htb

**Protocol**: HTTP

**Full URL**: http://dynamicdns.htb

**Timestamp**: Tue Aug 15 13:21:56 +0100 BST 2023
...
Date: Tue, 15 Aug 2023 12:21:54 GMT
...
- AIzaSyCWDPCiH080dNCTYC-uprmLOn2mt2BMSUk



**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://dynamicdns.htb'
```
