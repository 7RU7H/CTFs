### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://no-ip.htb

----
**Details**: **http-missing-security-headers:permissions-policy** matched at http://no-ip.htb
