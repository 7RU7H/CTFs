### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on http://no-ip.htb

----
**Details**: **http-missing-security-headers:clear-site-data** matched at http://no-ip.htb
