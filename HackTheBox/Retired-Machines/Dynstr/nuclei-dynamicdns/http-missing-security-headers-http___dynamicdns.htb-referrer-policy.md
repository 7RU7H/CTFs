### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on http://dynamicdns.htb

----
**Details**: **http-missing-security-headers:referrer-policy** matched at http://dynamicdns.htb
