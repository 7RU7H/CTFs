### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://dynamicdns.htb

----
**Details**: **http-missing-security-headers:permissions-policy** matched at http://dynamicdns.htb
