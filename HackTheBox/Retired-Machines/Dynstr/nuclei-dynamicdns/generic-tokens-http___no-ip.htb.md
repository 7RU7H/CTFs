### Generic Tokens (generic-tokens) found on http://no-ip.htb

----
**Details**: **generic-tokens** matched at http://no-ip.htb

**Protocol**: HTTP

**Full URL**: http://no-ip.htb

**Timestamp**: Tue Aug 15 13:09:48 +0100 BST 2023
...
Date: Tue, 15 Aug 2023 12:09:47 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.67 Safari/537.36' 'http://no-ip.htb'
```
