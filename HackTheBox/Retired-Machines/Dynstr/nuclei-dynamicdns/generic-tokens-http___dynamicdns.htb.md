### Generic Tokens (generic-tokens) found on http://dynamicdns.htb

----
**Details**: **generic-tokens** matched at http://dynamicdns.htb
...
Date: Tue, 15 Aug 2023 12:21:42 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2309.372 Safari/537.36' 'http://dynamicdns.htb'
```
