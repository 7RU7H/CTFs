### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://dynamicdns.htb

----
**Details**: **tech-detect:google-font-api** matched at http://dynamicdns.htb

**Protocol**: HTTP

**Full URL**: http://dynamicdns.htb

**Timestamp**: Tue Aug 15 13:21:44 +0100 BST 2023
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.124 Safari/537.36' 'http://dynamicdns.htb'
```
