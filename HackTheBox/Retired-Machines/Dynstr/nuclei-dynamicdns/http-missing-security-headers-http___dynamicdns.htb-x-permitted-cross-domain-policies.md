### HTTP Missing Security Headers (http-missing-security-headers:x-permitted-cross-domain-policies) found on http://dynamicdns.htb

----
**Details**: **http-missing-security-headers:x-permitted-cross-domain-policies** matched at http://dynamicdns.htb

**Protocol**: HTTP

**Full URL**: http://dynamicdns.htb

**Timestamp**: Tue Aug 15 13:21:43 +0100 BST 2023
...
Date: Tue, 15 Aug 2023 12:21:43 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1866.237 Safari/537.36' 'http://dynamicdns.htb'
```
