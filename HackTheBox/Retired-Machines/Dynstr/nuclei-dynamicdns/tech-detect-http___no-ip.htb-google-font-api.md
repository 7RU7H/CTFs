...
**Timestamp**: Tue Aug 15 13:09:49 +0100 BST 2023
...
Date: Tue, 15 Aug 2023 12:09:48 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2309.372 Safari/537.36' 'http://no-ip.htb'
```
