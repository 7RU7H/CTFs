### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on http://dnsalias.htb

----
**Details**: **http-missing-security-headers:clear-site-data** matched at http://dnsalias.htb
