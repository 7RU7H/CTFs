### Google API Key (google-api-key) found on http://dnsalias.htb

----
**Details**: **google-api-key** matched at http://dnsalias.htb

**Protocol**: HTTP

**Full URL**: http://dnsalias.htb

**Timestamp**: Tue Aug 15 13:49:42 +0100 BST 2023
...
Date: Tue, 15 Aug 2023 12:49:41 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2224.3 Safari/537.36' 'http://dnsalias.htb'
```
