### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://dnsalias.htb

----
**Details**: **tech-detect:google-font-api** matched at http://dnsalias.htb
