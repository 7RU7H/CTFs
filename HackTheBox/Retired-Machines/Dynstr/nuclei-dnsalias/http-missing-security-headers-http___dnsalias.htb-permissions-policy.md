### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://dnsalias.htb

----
**Details**: **http-missing-security-headers:permissions-policy** matched at http://dnsalias.htb
