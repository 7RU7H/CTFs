### WAF Detection (waf-detect:apachegeneric) found on http://dnsalias.htb

----
**Details**: **waf-detect:apachegeneric** matched at http://dnsalias.htb

**Protocol**: HTTP

**Full URL**: http://dnsalias.htb/

**Timestamp**: Tue Aug 15 13:50:03 +0100 BST 2023
...
Date: Tue, 15 Aug 2023 12:50:02 GMT
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: dnsalias.htb' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.67 Safari/537.36' 'http://dnsalias.htb/'
```
