### OpenSSH Service - Detect (openssh-detect) found on http://dnsalias.htb

----
**Details**: **openssh-detect** matched at http://dnsalias.htb

**Protocol**: TCP

**Full URL**: dnsalias.htb:22

**Timestamp**: Tue Aug 15 13:49:56 +0100 BST 2023
