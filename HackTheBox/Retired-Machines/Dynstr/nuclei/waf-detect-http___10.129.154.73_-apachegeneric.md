### WAF Detection (waf-detect:apachegeneric) found on http://10.129.154.73/

----
**Details**: **waf-detect:apachegeneric** matched at http://10.129.154.73/

**Protocol**: HTTP

**Full URL**: http://10.129.154.73/

**Timestamp**: Sun Jul 23 18:22:53 +0100 BST 2023
...
Date: Sun, 23 Jul 2023 17:22:45 GMT
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.154.73' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2762.73 Safari/537.36' 'http://10.129.154.73/'
```
