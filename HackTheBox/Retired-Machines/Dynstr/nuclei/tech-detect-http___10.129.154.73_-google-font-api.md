### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.129.154.73/

----
**Details**: **tech-detect:google-font-api** matched at http://10.129.154.73/

**Protocol**: HTTP

**Full URL**: http://10.129.154.73/

**Timestamp**: Sun Jul 23 18:22:54 +0100 BST 2023
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1944.0 Safari/537.36' 'http://10.129.154.73/'
```
