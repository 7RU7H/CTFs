### HTTP Missing Security Headers (http-missing-security-headers:x-permitted-cross-domain-policies) found on http://10.129.154.73/

----
**Details**: **http-missing-security-headers:x-permitted-cross-domain-policies** matched at http://10.129.154.73/

**Protocol**: HTTP

**Full URL**: http://10.129.154.73/

**Timestamp**: Sun Jul 23 18:22:55 +0100 BST 2023
...
Date: Sun, 23 Jul 2023 17:22:47 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2224.3 Safari/537.36' 'http://10.129.154.73/'
```
