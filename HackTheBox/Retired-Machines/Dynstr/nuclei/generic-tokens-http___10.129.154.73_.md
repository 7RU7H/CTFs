### Generic Tokens (generic-tokens) found on http://10.129.154.73/

----
**Details**: **generic-tokens** matched at http://10.129.154.73/

**Protocol**: HTTP

**Full URL**: http://10.129.154.73/

**Timestamp**: Sun Jul 23 18:22:51 +0100 BST 2023
...
Date: Sun, 23 Jul 2023 17:22:43 GMT
...
- key=AIzaSyCWDPCiH080dNCTYC-uprmLOn2mt2BMSUk
- Password: sndanyd
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2866.71 Safari/537.36' 'http://10.129.154.73/'
```
