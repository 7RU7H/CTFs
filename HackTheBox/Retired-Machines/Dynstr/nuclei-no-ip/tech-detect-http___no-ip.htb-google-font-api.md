### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://no-ip.htb

----
**Details**: **tech-detect:google-font-api** matched at http://no-ip.htb

**Protocol**: HTTP

**Full URL**: http://no-ip.htb

**Timestamp**: Tue Aug 15 13:23:47 +0100 BST 2023
...
Date: Tue, 15 Aug 2023 12:23:46 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1866.237 Safari/537.36' 'http://no-ip.htb'
```
