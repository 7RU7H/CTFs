### WAF Detection (waf-detect:apachegeneric) found on http://10.129.198.211
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.129.198.211

**Protocol**: HTTP

**Full URL**: http://10.129.198.211/

**Timestamp**: Tue Apr 25 14:54:04 +0100 BST 2023
...
Set-Cookie: c0548020854924e0aecd05ed9f5b672b=irg1q09c41krq1guqd7tp9r3fr; path=/; HttpOnly
...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"9b0a2b3990e84724bc974e8d93519916","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.198.211' -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2820.59 Safari/537.36' 'http://10.129.198.211/'
```
---
