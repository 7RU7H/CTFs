### Joomla! Panel (joomla-panel) found on http://10.129.198.211
---
**Details**: **joomla-panel**  matched at http://10.129.198.211

**Protocol**: HTTP

**Full URL**: http://10.129.198.211/administrator/

**Timestamp**: Tue Apr 25 14:53:53 +0100 BST 2023
...
Date: Tue, 25 Apr 2023 13:53:53 GMT
Expires: Wed, 17 Aug 2005 00:00:00 GMT
Last-Modified: Tue, 25 Apr 2023 13:53:53 GMT
Pragma: no-cache
Server: Apache/2.4.29 (Ubuntu)
Set-Cookie: 99fb082d992a92668ce87e5540bd20fa=sk8j1n5d2g1326ei381vk31r7m; path=/; HttpOnly
...
<head>
	...
	<title>Cewl Curling site! - Administration</title>
	<link href="/administrator/templates/isis/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />
	<link href="/administrator/templates/isis/css/template.css?b6bf078482bc6a711b54fa9e74e19603" rel="stylesheet" />
	<style>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"351886e57a6faa5bcd6c1d2b13a1a5b1","system.paths":{"root":"","base":"\/administrator"},"system.keepalive":{"interval":840000,"uri":"\/administrator\/index.php"}}</script>
...
<body class="site com_login view-login layout-default task- itemid- ">
	...
	<div class="container">
		<div id="content">
			...
			<div id="element-box" class="login well">
									<img src="/administrator/templates/isis/images/joomla.png" alt="Cewl Curling site!" />
								<hr />
	...
	<fieldset class="loginform">
		<div class="control-group">
			<div class="controls">
				<div class="input-prepend input-append">
					...
					<a href="http://10.129.198.211/index.php?option=com_users&view=remind" class="btn width-auto hasTooltip" title="Forgot your username?">
		...
		<div class="control-group">
			<div class="controls">
				<div class="input-prepend input-append">
					...
					<a href="http://10.129.198.211/index.php?option=com_users&view=reset" class="btn width-auto hasTooltip" title="Forgot your password?">
						<span class="icon-help"></span>
					</a>
				</div>
			</div>
		...
		<input type="hidden" name="351886e57a6faa5bcd6c1d2b13a1a5b1" value="1" />	</fieldset>
</form>
	...
	<div class="navbar navbar-fix.... Truncated ....
```


**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2656.18 Safari/537.36' 'http://10.129.198.211/administrator/'
```
---
