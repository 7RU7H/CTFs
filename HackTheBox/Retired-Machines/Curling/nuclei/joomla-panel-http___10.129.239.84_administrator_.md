### Joomla! Panel (joomla-panel) found on http://10.129.239.84
---
**Details**: **joomla-panel**  matched at http://10.129.239.84

**Protocol**: HTTP

**Full URL**: http://10.129.239.84/administrator/

**Timestamp**: Wed Jan 25 14:19:09 +0000 GMT 2023
...
Date: Wed, 25 Jan 2023 14:19:08 GMT
Expires: Wed, 17 Aug 2005 00:00:00 GMT
Last-Modified: Wed, 25 Jan 2023 14:19:08 GMT
Pragma: no-cache
Server: Apache/2.4.29 (Ubuntu)
Set-Cookie: 99fb082d992a92668ce87e5540bd20fa=h9g2noscqk2ivcvqcpj3t6riim; path=/; HttpOnly
...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"ebe046f50e4b1fe3fe1e3fa616d954f6","system.paths":{"root":"","base":"\/administrator"},"system.keepalive":{"interval":840000,"uri":"\/administrator\/index.php"}}</script>
...
<body class="site com_login view-login layout-default task- itemid- ">
	...
	<fieldset class="loginform">
		<div class="control-group">
			<div class="controls">
				<div class="input-prepend input-append">
					...
					<a href="http://10.129.239.84/index.php?option=com_users&view=remind" class="btn width-auto hasTooltip" title="Forgot your username?">
		...
		<div class="control-group">
			<div class="controls">
				<div class="input-prepend input-append">
					...
					<a href="http://10.129.239.84/index.php?option=com_users&view=reset" class="btn width-auto hasTooltip" title="Forgot your password?">
						<span class="icon-help"></span>
					</a>
				</div>
			</div>
		...
		<input type="hidden" name="ebe046f50e4b1fe3fe1e3fa616d954f6" value="1" />	</fieldset>
</form>
	...
	<div class="navbar navbar-fixed.... Truncated ....
```


**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2820.59 Safari/537.36' 'http://10.129.239.84/administrator/'
```
---
