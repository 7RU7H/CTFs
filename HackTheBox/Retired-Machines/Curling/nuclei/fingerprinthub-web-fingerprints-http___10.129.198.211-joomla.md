### FingerprintHub Technology Fingerprint (fingerprinthub-web-fingerprints:joomla) found on http://10.129.198.211
---
**Details**: **fingerprinthub-web-fingerprints:joomla**  matched at http://10.129.198.211
...
Set-Cookie: c0548020854924e0aecd05ed9f5b672b=vhlr23fpfo6gprap1ujq3e95rr; path=/; HttpOnly
...
<head>
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"0d584f6483db472926d71fc5a9de64d3","system.paths":{"root":"","base":""},"system.keepalive":{"interval":840000,"uri":"\/index.php\/component\/ajax\/?format=json"}}</script>
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 4.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2049.0 Safari/537.36' 'http://10.129.198.211'
```
---
