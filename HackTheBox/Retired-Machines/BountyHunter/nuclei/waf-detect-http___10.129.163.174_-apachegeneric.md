### WAF Detection (waf-detect:apachegeneric) found on http://10.129.163.174/
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.129.163.174/

**Protocol**: HTTP

**Full URL**: http://10.129.163.174/

**Timestamp**: Sat Jun 17 16:51:54 +0100 BST 2023
...
Date: Sat, 17 Jun 2023 15:51:22 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.163.174' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1866.237 Safari/537.36' 'http://10.129.163.174/'
```
---
