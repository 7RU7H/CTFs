### WAF Detection (waf-detect:apachegeneric) found on http://10.129.17.202
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.129.17.202

**Protocol**: HTTP

**Full URL**: http://10.129.17.202/

**Timestamp**: Mon Nov 21 13:51:37 +0000 GMT 2022
...
Date: Mon, 21 Nov 2022 13:51:37 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.17.202' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2309.372 Safari/537.36' 'http://10.129.17.202/'
```
---
