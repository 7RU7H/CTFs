### Nginx version detect (nginx-version) found on https://10.129.163.144/
---
**Details**: **nginx-version**  matched at https://10.129.163.144/
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 4.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2049.0 Safari/537.36' 'https://10.129.163.144/'
```
---
