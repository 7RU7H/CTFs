### Wappalyzer Technology Detection (tech-detect:nginx) found on https://10.129.163.144/
---
**Details**: **tech-detect:nginx**  matched at https://10.129.163.144/

**Protocol**: HTTP

**Full URL**: https://10.129.163.144/

**Timestamp**: Sat Jun 17 20:17:30 +0100 BST 2023
...
Date: Sat, 17 Jun 2023 19:16:59 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2117.157 Safari/537.36' 'https://10.129.163.144/'
```
---
