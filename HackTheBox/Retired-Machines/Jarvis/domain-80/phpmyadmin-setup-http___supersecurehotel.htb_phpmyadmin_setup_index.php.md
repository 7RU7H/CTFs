### Publicly Accessible Phpmyadmin Setup (phpmyadmin-setup) found on http://supersecurehotel.htb
---
**Details**: **phpmyadmin-setup**  matched at http://supersecurehotel.htb

**Protocol**: HTTP

**Full URL**: http://supersecurehotel.htb/phpmyadmin/setup/index.php

**Timestamp**: Sat Nov 19 17:08:58 +0000 GMT 2022
...
Date: Sat, 19 Nov 2022 17:08:59 GMT
Expires: Sat, 19 Nov 2022 17:08:59 +0000
Ironwaf: 2.0.3
Last-Modified: Sat, 19 Nov 2022 17:08:59 +0000
Pragma: no-cache
Server: Apache/2.4.25 (Debian)
Set-Cookie: phpMyAdmin=glf5450f20hh0vj15f4ejjd64pgc6h0m; path=/phpmyadmin/setup/; HttpOnly
Set-Cookie: phpMyAdmin=glf5450f20hh0vj15f4ejjd64pgc6h0m; path=/phpmyadmin/setup/; HttpOnly
Set-Cookie: pma_lang=en; expires=Mon, 19-Dec-2022 17:08:59 GMT; Max-Age=2592000; path=/phpmyadmin/setup/; HttpOnly
...
<div id="page">
<form id="select_lang" method="post"><input type="hidden" name="lang" value="en" /><input type="hidden" name="token" value="+d&gt;:(v&quot;o$),g/U]&quot;" /><bdo lang="en" dir="ltr"><label for="lang">Language</label></bdo><br /><select id="lang" name="lang" class="autosubmit" lang="en" dir="ltr"><option value="ar">&#1575;&#1604;&#1593;&#1585;&#1576;&#1610;&#1577; - Arabic</option>
...
</select></form><h2>Overview</h2><div class="error" id="BZipDump"><h4>Bzip2</h4><a href="?page=form&amp;formset=Features&amp;lang=en#tab_Import_export">Bzip2 compressi.... Truncated ....
```


**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36' 'http://supersecurehotel.htb/phpmyadmin/setup/index.php'
```
---
