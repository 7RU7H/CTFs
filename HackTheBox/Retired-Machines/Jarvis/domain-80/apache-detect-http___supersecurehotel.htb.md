### Apache Detection (apache-detect) found on http://supersecurehotel.htb
---
**Details**: **apache-detect**  matched at http://supersecurehotel.htb
...
Set-Cookie: PHPSESSID=t0eqge8s7ek6635bvr6cva8la7; path=/
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.67 Safari/537.36' 'http://supersecurehotel.htb'
```
---
