### Wappalyzer Technology Detection (tech-detect:owl-carousel) found on http://10.129.227.147
---
**Details**: **tech-detect:owl-carousel**  matched at http://10.129.227.147
...
Date: Tue, 15 Nov 2022 12:38:39 GMT
Expires: Thu, 19 Nov 1981 08:52:00 GMT
Ironwaf: 2.0.3
Pragma: no-cache
Server: Apache/2.4.25 (Debian)
Set-Cookie: PHPSESSID=hr6rrsbc69nbumb1n7aprj4m80; path=/
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.1 Safari/537.36' 'http://10.129.227.147'
```
---
