### Apache Detection (apache-detect) found on http://10.129.227.147
---
**Details**: **apache-detect**  matched at http://10.129.227.147

**Protocol**: HTTP

**Full URL**: http://10.129.227.147

**Timestamp**: Tue Nov 15 12:38:37 +0000 GMT 2022
...
Date: Tue, 15 Nov 2022 12:38:38 GMT
Expires: Thu, 19 Nov 1981 08:52:00 GMT
Ironwaf: 2.0.3
Pragma: no-cache
Server: Apache/2.4.25 (Debian)
Set-Cookie: PHPSESSID=fqhstlt4rorb8m5t4f4u5tllg3; path=/
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36' 'http://10.129.227.147'
```
---
