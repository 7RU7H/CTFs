### nginx version detect (nginx-version) found on http://10.129.227.134
---
**Details**: **nginx-version**  matched at http://10.129.227.134

**Protocol**: HTTP

**Full URL**: http://10.129.227.134

**Timestamp**: Wed May 4 08:28:49 +0100 BST 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36' 'http://10.129.227.134'
```
---
