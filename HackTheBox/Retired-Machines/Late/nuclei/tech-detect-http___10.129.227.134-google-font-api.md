### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.129.227.134
---
**Details**: **tech-detect:google-font-api**  matched at http://10.129.227.134

**Protocol**: HTTP

**Full URL**: http://10.129.227.134

**Timestamp**: Wed May 4 08:28:50 +0100 BST 2022
...
Date: Wed, 04 May 2022 07:28:49 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.77 Safari/537.36' 'http://10.129.227.134'
```
---
