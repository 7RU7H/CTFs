### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on http://monitor.bart.htb
---
**Details**: **http-missing-security-headers:referrer-policy**  matched at http://monitor.bart.htb
