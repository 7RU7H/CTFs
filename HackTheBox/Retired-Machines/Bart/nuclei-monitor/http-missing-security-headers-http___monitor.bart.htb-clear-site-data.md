### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on http://monitor.bart.htb
---
**Details**: **http-missing-security-headers:clear-site-data**  matched at http://monitor.bart.htb
