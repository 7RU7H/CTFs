### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://monitor.bart.htb
---
**Details**: **http-missing-security-headers:permissions-policy**  matched at http://monitor.bart.htb
