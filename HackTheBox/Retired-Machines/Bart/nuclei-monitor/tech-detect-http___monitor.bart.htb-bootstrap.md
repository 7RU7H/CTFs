### Wappalyzer Technology Detection (tech-detect:bootstrap) found on http://monitor.bart.htb
---
**Details**: **tech-detect:bootstrap**  matched at http://monitor.bart.htb
...
Set-Cookie: PHPSESSID=7qqsqj5c54hpp2ah5vnh88tv1m; path=/
...
<html lang="en" dir="ltr" class="ltr">
  ...
  <form class="form-signin" method="post">
	<input type="hidden" name="csrf" value="9f9cef4de3829a57d365f6cacf9917f5fe0cdd60619932a9a8b375abd168e67b" />
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36' 'http://monitor.bart.htb'
```
---
