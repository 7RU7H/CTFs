### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on http://shoppy.htb
---
**Details**: **http-missing-security-headers:referrer-policy**  matched at http://shoppy.htb
