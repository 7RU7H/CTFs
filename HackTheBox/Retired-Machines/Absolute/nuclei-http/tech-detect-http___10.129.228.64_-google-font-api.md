### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.129.228.64/

----
**Details**: **tech-detect:google-font-api** matched at http://10.129.228.64/

**Protocol**: HTTP

**Full URL**: http://10.129.228.64/

**Timestamp**: Thu Jun 29 20:53:51 +0100 BST 2023
...
Date: Fri, 30 Jun 2023 02:53:08 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2656.18 Safari/537.36' 'http://10.129.228.64/'
```
