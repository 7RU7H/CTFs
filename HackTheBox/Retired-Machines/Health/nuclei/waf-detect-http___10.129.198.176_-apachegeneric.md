### WAF Detection (waf-detect:apachegeneric) found on http://10.129.198.176
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.129.198.176

**Protocol**: HTTP

**Full URL**: http://10.129.198.176/

**Timestamp**: Tue Apr 25 10:22:53 +0100 BST 2023
...
Date: Tue, 25 Apr 2023 09:22:49 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.198.176' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://10.129.198.176/'
```
---
