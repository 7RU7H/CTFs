### Apache Detection (apache-detect) found on http://10.129.95.236
---
**Details**: **apache-detect**  matched at http://10.129.95.236

**Protocol**: HTTP

**Full URL**: http://10.129.95.236

**Timestamp**: Thu Jun 16 17:51:40 +0100 BST 2022
...
Date: Thu, 16 Jun 2022 16:51:40 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.124 Safari/537.36' 'http://10.129.95.236'
```
---
