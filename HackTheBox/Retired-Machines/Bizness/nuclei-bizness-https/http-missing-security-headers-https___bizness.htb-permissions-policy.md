### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on bizness.htb

----
**Details**: **http-missing-security-headers:permissions-policy** matched at bizness.htb
