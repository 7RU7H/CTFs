### Wappalyzer Technology Detection (tech-detect:google-font-api) found on bizness.htb

----
**Details**: **tech-detect:google-font-api** matched at bizness.htb

**Protocol**: HTTP

**Full URL**: https://bizness.htb

**Timestamp**: Sat Jan 6 19:38:05 +0000 GMT 2024
...
Date: Sat, 06 Jan 2024 19:38:03 GMT
Etag: W/"27200-1702887508516"
Last-Modified: Mon, 18 Dec 2023 08:18:28 GMT
Server: nginx/1.18.0
Set-Cookie: JSESSIONID=47204296D2D1BB4B330F58C04D84EF22.jvm1; Path=/; Secure; HttpOnly
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2866.71 Safari/537.36' 'https://bizness.htb'
```
