### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on bizness.htb

----
**Details**: **http-missing-security-headers:x-content-type-options** matched at bizness.htb
