### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on bizness.htb

----
**Details**: **http-missing-security-headers:clear-site-data** matched at bizness.htb
