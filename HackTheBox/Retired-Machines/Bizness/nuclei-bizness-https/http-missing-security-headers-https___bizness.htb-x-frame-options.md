### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on bizness.htb

----
**Details**: **http-missing-security-headers:x-frame-options** matched at bizness.htb
