### WAF Detection (waf-detect:apachegeneric) found on bizness.htb

----
**Details**: **waf-detect:apachegeneric** matched at bizness.htb

**Protocol**: HTTP

**Full URL**: https://bizness.htb/

**Timestamp**: Sat Jan 6 19:42:33 +0000 GMT 2024
...
Date: Sat, 06 Jan 2024 19:42:31 GMT
Etag: W/"27200-1702887508516"
Last-Modified: Mon, 18 Dec 2023 08:18:28 GMT
Server: nginx/1.18.0
Set-Cookie: JSESSIONID=8115340792D382E03AA7998F903DC34A.jvm1; Path=/; Secure; HttpOnly
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: bizness.htb' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2226.0 Safari/537.36' 'https://bizness.htb/'
```
