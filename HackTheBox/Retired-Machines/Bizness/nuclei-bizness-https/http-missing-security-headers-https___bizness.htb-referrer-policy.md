### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on bizness.htb

----
**Details**: **http-missing-security-headers:referrer-policy** matched at bizness.htb
