### DOM EventListener - Cross-Site Scripting (addeventlistener-detect) found on 10.129.95.163

----
**Details**: **addeventlistener-detect** matched at 10.129.95.163

**Protocol**: HTTP

**Full URL**: http://10.129.95.163

**Timestamp**: Thu Mar 28 09:56:34 +0000 GMT 2024
...
Date: Thu, 28 Mar 2024 09:56:35 GMT
Expires: Thu, 19 Nov 1981 08:52:00 GMT
Pragma: no-cache
Server: Apache/2.4.29 (Ubuntu)
Set-Cookie: PHPSESSID=5vpq0n70gbfgtnppm7qhideltv; path=/
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.61 Safari/537.36' 'http://10.129.95.163'
```
