### Wappalyzer Technology Detection (tech-detect:nginx) found on https://sup3rs3cr3t.brainfuck.htb
---
**Details**: **tech-detect:nginx**  matched at https://sup3rs3cr3t.brainfuck.htb
