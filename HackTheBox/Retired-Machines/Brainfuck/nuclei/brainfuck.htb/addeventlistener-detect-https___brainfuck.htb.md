### DOM EventListener detection (addeventlistener-detect) found on https://brainfuck.htb
---
**Details**: **addeventlistener-detect**  matched at https://brainfuck.htb

**Protocol**: HTTP

**Full URL**: https://brainfuck.htb

**Timestamp**: Wed Aug 17 20:46:46 +0100 BST 2022
...
Date: Wed, 17 Aug 2022 19:46:47 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2762.73 Safari/537.36' 'https://brainfuck.htb'
```
---
