### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://exams.seventeen.htb
---
**Details**: **http-missing-security-headers:permissions-policy**  matched at http://exams.seventeen.htb
