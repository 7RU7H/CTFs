### PyPI Server Detect (pypiserver-detect) found on http://exams.seventeen.htb
---
**Details**: **pypiserver-detect**  matched at http://exams.seventeen.htb
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.1 Safari/537.36' 'http://exams.seventeen.htb'
```
---
