### WAF Detection (waf-detect:apachegeneric) found on http://exams.seventeen.htb
---
**Details**: **waf-detect:apachegeneric**  matched at http://exams.seventeen.htb

**Protocol**: HTTP

**Full URL**: http://exams.seventeen.htb/

**Timestamp**: Thu Dec 15 20:17:01 +0000 GMT 2022
...
Date: Thu, 15 Dec 2022 20:17:01 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: exams.seventeen.htb' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.47 Safari/537.36' 'http://exams.seventeen.htb/'
```
---
