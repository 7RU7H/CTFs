### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://exams.seventeen.htb
---
**Details**: **tech-detect:google-font-api**  matched at http://exams.seventeen.htb
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.67 Safari/537.36' 'http://exams.seventeen.htb'
```
---
