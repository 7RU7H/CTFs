### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on http://exams.seventeen.htb
---
**Details**: **http-missing-security-headers:referrer-policy**  matched at http://exams.seventeen.htb
