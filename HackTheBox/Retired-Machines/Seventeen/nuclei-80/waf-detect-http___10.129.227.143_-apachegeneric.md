### WAF Detection (waf-detect:apachegeneric) found on http://10.129.227.143
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.129.227.143

**Protocol**: HTTP

**Full URL**: http://10.129.227.143/

**Timestamp**: Thu Dec 15 18:12:22 +0000 GMT 2022
...
Date: Thu, 15 Dec 2022 18:12:21 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.227.143' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2762.73 Safari/537.36' 'http://10.129.227.143/'
```
---
