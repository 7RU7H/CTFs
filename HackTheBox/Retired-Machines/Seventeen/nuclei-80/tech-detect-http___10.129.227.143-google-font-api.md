### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.129.227.143
---
**Details**: **tech-detect:google-font-api**  matched at http://10.129.227.143

**Protocol**: HTTP

**Full URL**: http://10.129.227.143

**Timestamp**: Thu Dec 15 18:11:51 +0000 GMT 2022
...
Date: Thu, 15 Dec 2022 18:11:49 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.67 Safari/537.36' 'http://10.129.227.143'
```
---
