### Apache Detection (apache-detect) found on http://10.129.227.143
---
**Details**: **apache-detect**  matched at http://10.129.227.143

**Protocol**: HTTP

**Full URL**: http://10.129.227.143

**Timestamp**: Thu Dec 15 18:11:50 +0000 GMT 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'http://10.129.227.143'
```
---
