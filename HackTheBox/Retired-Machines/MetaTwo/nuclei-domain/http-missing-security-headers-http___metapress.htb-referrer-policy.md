### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on http://metapress.htb
---
**Details**: **http-missing-security-headers:referrer-policy**  matched at http://metapress.htb
