### Metatag CMS Detection (metatag-cms) found on http://metapress.htb
---
**Details**: **metatag-cms**  matched at http://metapress.htb

**Protocol**: HTTP

**Full URL**: http://metapress.htb

**Timestamp**: Sat Nov 12 12:35:51 +0000 GMT 2022
...
Pragma: no-cache
Server: nginx/1.18.0
Set-Cookie: PHPSESSID=2aa9rng7tc6364af8a1oc1vm2v; path=/
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2117.157 Safari/537.36' 'http://metapress.htb'
```
---
