### WordPress Detect (wordpress-detect) found on http://metapress.htb
---
**Details**: **wordpress-detect**  matched at http://metapress.htb

**Protocol**: HTTP

**Full URL**: http://metapress.htb

**Timestamp**: Sat Nov 12 12:36:30 +0000 GMT 2022
...
Date: Sat, 12 Nov 2022 12:36:29 GMT
Expires: Thu, 19 Nov 1981 08:52:00 GMT
Link: <http://metapress.htb/wp-json/>; rel="https://api.w.org/"
Pragma: no-cache
Server: nginx/1.18.0
Set-Cookie: PHPSESSID=d96cf7ngrvjbq0956hgssolk90; path=/
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2820.59 Safari/537.36' 'http://metapress.htb'
```
---
