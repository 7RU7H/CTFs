### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://metapress.htb
---
**Details**: **http-missing-security-headers:permissions-policy**  matched at http://metapress.htb
