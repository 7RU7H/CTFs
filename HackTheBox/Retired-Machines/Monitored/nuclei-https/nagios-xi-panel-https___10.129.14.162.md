### Nagios XI Login Panel - Detect (nagios-xi-panel) found on 10.129.14.162

----
**Details**: **nagios-xi-panel** matched at 10.129.14.162

**Protocol**: HTTP

**Full URL**: https://10.129.14.162

**Timestamp**: Sun Jan 14 17:47:07 +0000 GMT 2024
...
Date: Sun, 14 Jan 2024 17:46:57 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36' 'https://10.129.14.162'
```
