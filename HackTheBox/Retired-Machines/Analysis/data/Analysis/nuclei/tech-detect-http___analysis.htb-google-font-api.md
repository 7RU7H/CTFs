### Wappalyzer Technology Detection (tech-detect:google-font-api) found on analysis.htb

----
**Details**: **tech-detect:google-font-api** matched at analysis.htb

**Protocol**: HTTP

**Full URL**: http://analysis.htb

**Timestamp**: Sat Jan 20 20:03:31 +0000 GMT 2024
...
Date: Sat, 20 Jan 2024 20:03:18 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2225.0 Safari/537.36' 'http://analysis.htb'
```
