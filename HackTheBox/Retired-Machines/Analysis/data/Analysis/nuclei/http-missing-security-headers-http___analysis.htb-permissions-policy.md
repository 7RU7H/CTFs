### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on analysis.htb

----
**Details**: **http-missing-security-headers:permissions-policy** matched at analysis.htb
