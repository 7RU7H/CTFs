### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on analysis.htb

----
**Details**: **http-missing-security-headers:clear-site-data** matched at analysis.htb
