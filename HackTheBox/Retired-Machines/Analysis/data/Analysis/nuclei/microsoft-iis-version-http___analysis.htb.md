### Microsoft IIS version detect (microsoft-iis-version) found on analysis.htb

----
**Details**: **microsoft-iis-version** matched at analysis.htb

**Protocol**: HTTP

**Full URL**: http://analysis.htb

**Timestamp**: Sat Jan 20 20:03:13 +0000 GMT 2024
...
Date: Sat, 20 Jan 2024 20:03:01 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2762.73 Safari/537.36' 'http://analysis.htb'
```
