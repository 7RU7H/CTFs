### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on analysis.htb

----
**Details**: **http-missing-security-headers:x-content-type-options** matched at analysis.htb
