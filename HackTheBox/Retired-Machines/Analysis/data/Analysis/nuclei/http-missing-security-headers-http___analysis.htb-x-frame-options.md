### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on analysis.htb

----
**Details**: **http-missing-security-headers:x-frame-options** matched at analysis.htb
