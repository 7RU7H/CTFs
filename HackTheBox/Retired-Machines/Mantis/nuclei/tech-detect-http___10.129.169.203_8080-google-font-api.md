### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.129.169.203:8080
---
**Details**: **tech-detect:google-font-api**  matched at http://10.129.169.203:8080

**Protocol**: HTTP

**Full URL**: http://10.129.169.203:8080

**Timestamp**: Mon Jun 6 12:04:10 +0100 BST 2022
...
Date: Mon, 06 Jun 2022 11:04:09 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36' 'http://10.129.169.203:8080'
```
---
