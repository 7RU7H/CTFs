### HTTP Missing Security Headers (http-missing-security-headers:x-permitted-cross-domain-policies) found on http://10.129.234.48/music
---
**Details**: **http-missing-security-headers:x-permitted-cross-domain-policies**  matched at http://10.129.234.48/music

**Protocol**: HTTP

**Full URL**: http://10.129.234.48/music/

**Timestamp**: Sun Feb 26 12:48:12 +0000 GMT 2023
...
Date: Sun, 26 Feb 2023 12:48:11 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'Referer: http://10.129.234.48/music' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2309.372 Safari/537.36' 'http://10.129.234.48/music/'
```
---
