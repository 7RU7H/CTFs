### Exposed File Upload Form (exposed-file-upload-form) found on comprezzor.htb

----
**Details**: **exposed-file-upload-form** matched at comprezzor.htb

**Protocol**: HTTP

**Full URL**: http://comprezzor.htb

**Timestamp**: Sat Apr 27 20:32:53 +0100 BST 2024
...
Date: Sat, 27 Apr 2024 19:32:54 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1788.0' 'http://comprezzor.htb'
```
