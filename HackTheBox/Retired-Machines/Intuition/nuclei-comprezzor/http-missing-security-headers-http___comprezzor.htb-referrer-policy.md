### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on comprezzor.htb

----
**Details**: **http-missing-security-headers:referrer-policy** matched at comprezzor.htb
