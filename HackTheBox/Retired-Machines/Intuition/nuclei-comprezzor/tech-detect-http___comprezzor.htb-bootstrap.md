### Wappalyzer Technology Detection (tech-detect:bootstrap) found on comprezzor.htb

----
**Details**: **tech-detect:bootstrap** matched at comprezzor.htb

**Protocol**: HTTP

**Full URL**: http://comprezzor.htb

**Timestamp**: Sat Apr 27 20:33:13 +0100 BST 2024
...
Date: Sat, 27 Apr 2024 19:33:13 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; rv:57.0) Gecko/20100101 Firefox/57.0' 'http://comprezzor.htb'
```
