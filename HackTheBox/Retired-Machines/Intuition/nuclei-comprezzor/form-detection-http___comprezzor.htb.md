### Form Detection (form-detection) found on comprezzor.htb

----
**Details**: **form-detection** matched at comprezzor.htb

**Protocol**: HTTP

**Full URL**: http://comprezzor.htb

**Timestamp**: Sat Apr 27 20:33:17 +0100 BST 2024
...
GET / HTTP/1.1
Host: comprezzor.htb
User-Agent: Mozilla/5.0 (Macintosh; U; PPC Mac OS X; fr) AppleWebKit/416.12 (KHTML, like Gecko) Safari/412.5
Connection: close
Accept: */*
Accept-Language: en
...
Date: Sat, 27 Apr 2024 19:33:17 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; U; PPC Mac OS X; fr) AppleWebKit/416.12 (KHTML, like Gecko) Safari/412.5' 'http://comprezzor.htb'
```
