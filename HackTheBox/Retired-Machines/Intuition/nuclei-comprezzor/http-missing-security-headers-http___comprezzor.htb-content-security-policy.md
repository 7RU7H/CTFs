### HTTP Missing Security Headers (http-missing-security-headers:content-security-policy) found on comprezzor.htb

----
**Details**: **http-missing-security-headers:content-security-policy** matched at comprezzor.htb
