### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on comprezzor.htb

----
**Details**: **http-missing-security-headers:x-frame-options** matched at comprezzor.htb
