### Missing Subresource Integrity (missing-sri) found on report.comprezzor.htb

----
**Details**: **missing-sri** matched at report.comprezzor.htb

**Protocol**: HTTP

**Full URL**: http://report.comprezzor.htb/

**Timestamp**: Sat Apr 27 21:56:39 +0100 BST 2024
...
Date: Sat, 27 Apr 2024 20:56:40 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Host: report.comprezzor.htb' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:68.0) Gecko/20100101 Firefox/68.0' 'http://report.comprezzor.htb/'
```
