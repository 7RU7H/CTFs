### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on report.comprezzor.htb

----
**Details**: **http-missing-security-headers:x-content-type-options** matched at report.comprezzor.htb
