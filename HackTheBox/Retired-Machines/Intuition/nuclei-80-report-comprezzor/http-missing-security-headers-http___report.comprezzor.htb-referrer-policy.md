### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on report.comprezzor.htb

----
**Details**: **http-missing-security-headers:referrer-policy** matched at report.comprezzor.htb
