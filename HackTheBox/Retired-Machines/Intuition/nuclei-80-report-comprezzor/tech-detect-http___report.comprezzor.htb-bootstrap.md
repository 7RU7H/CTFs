### Wappalyzer Technology Detection (tech-detect:bootstrap) found on report.comprezzor.htb

----
**Details**: **tech-detect:bootstrap** matched at report.comprezzor.htb

**Protocol**: HTTP

**Full URL**: http://report.comprezzor.htb

**Timestamp**: Sat Apr 27 21:56:14 +0100 BST 2024
...
Date: Sat, 27 Apr 2024 20:56:14 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.41' 'http://report.comprezzor.htb'
```
