### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on report.comprezzor.htb

----
**Details**: **http-missing-security-headers:clear-site-data** matched at report.comprezzor.htb
