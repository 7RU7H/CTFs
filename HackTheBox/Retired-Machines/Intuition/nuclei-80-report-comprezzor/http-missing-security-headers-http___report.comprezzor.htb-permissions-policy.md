### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on report.comprezzor.htb

----
**Details**: **http-missing-security-headers:permissions-policy** matched at report.comprezzor.htb
