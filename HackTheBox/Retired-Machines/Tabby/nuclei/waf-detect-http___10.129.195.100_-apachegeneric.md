### WAF Detection (waf-detect:apachegeneric) found on http://10.129.195.100
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.129.195.100

**Protocol**: HTTP

**Full URL**: http://10.129.195.100/

**Timestamp**: Mon May 1 10:32:12 +0100 BST 2023
...
Date: Mon, 01 May 2023 09:32:11 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.195.100' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML like Gecko) Chrome/44.0.2403.155 Safari/537.36' 'http://10.129.195.100/'
```
---
