### Wappalyzer Technology Detection (tech-detect:ms-iis) found on http://10.129.96.147
---
**Details**: **tech-detect:ms-iis**  matched at http://10.129.96.147

**Protocol**: HTTP

**Full URL**: http://10.129.96.147

**Timestamp**: Fri Feb 10 18:31:32 +0000 GMT 2023
...
Date: Fri, 10 Feb 2023 18:31:31 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.67 Safari/537.36' 'http://10.129.96.147'
```
---
