### Microsoft IIS version detect (microsoft-iis-version) found on http://10.129.95.233
---
**Details**: **microsoft-iis-version**  matched at http://10.129.95.233

**Protocol**: HTTP

**Full URL**: http://10.129.95.233

**Timestamp**: Thu May 26 21:48:08 +0100 BST 2022
...
Date: Thu, 26 May 2022 20:48:08 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2919.83 Safari/537.36' 'http://10.129.95.233'
```
---
