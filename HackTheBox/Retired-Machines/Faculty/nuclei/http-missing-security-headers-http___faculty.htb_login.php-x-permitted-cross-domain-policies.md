### HTTP Missing Security Headers (http-missing-security-headers:x-permitted-cross-domain-policies) found on http://10.129.64.49
---
**Details**: **http-missing-security-headers:x-permitted-cross-domain-policies**  matched at http://10.129.64.49

**Protocol**: HTTP

**Full URL**: http://faculty.htb/login.php

**Timestamp**: Mon Aug 8 20:28:21 +0100 BST 2022
...
Date: Mon, 08 Aug 2022 19:28:20 GMT
Expires: Thu, 19 Nov 1981 08:52:00 GMT
Pragma: no-cache
Server: nginx/1.18.0 (Ubuntu)
Set-Cookie: PHPSESSID=dno4m7n274k8bgqj3gvpo3jnai; path=/
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'Referer: http://faculty.htb' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.1 Safari/537.36' 'http://faculty.htb/login.php'
```
---
