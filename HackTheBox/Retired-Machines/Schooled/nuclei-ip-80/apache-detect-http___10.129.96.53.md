### Apache Detection (apache-detect) found on 10.129.96.53

----
**Details**: **apache-detect** matched at 10.129.96.53

**Protocol**: HTTP

**Full URL**: http://10.129.96.53

**Timestamp**: Sun Apr 28 16:07:41 +0100 BST 2024
...
Date: Sun, 28 Apr 2024 15:07:40 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:101.0) Gecko/20100101 Firefox/101.0' 'http://10.129.96.53'
```
