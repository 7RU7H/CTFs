### Wappalyzer Technology Detection (tech-detect:bootstrap) found on 10.129.96.53

----
**Details**: **tech-detect:bootstrap** matched at 10.129.96.53

**Protocol**: HTTP

**Full URL**: http://10.129.96.53

**Timestamp**: Sun Apr 28 16:08:01 +0100 BST 2024
...
Date: Sun, 28 Apr 2024 15:08:00 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows; U; Windows NT 6.0; en-US; rv:1.9.1.2) Gecko/20090729 Firefox/3.5.2 (.NET CLR 3.5.30729)' 'http://10.129.96.53'
```
