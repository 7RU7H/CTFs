### WAF Detection (waf-detect:apachegeneric) found on 10.129.96.53

----
**Details**: **waf-detect:apachegeneric** matched at 10.129.96.53

**Protocol**: HTTP

**Full URL**: http://10.129.96.53/

**Timestamp**: Sun Apr 28 16:08:32 +0100 BST 2024
...
Date: Sun, 28 Apr 2024 15:08:32 GMT
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.96.53' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/534.34 (KHTML, like Gecko) wkhtmltopdf Safari/534.34' 'http://10.129.96.53/'
```
