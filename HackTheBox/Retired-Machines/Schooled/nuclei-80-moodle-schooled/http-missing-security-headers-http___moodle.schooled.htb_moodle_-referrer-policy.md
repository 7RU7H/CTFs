### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on moodle.schooled.htb

----
**Details**: **http-missing-security-headers:referrer-policy** matched at moodle.schooled.htb
