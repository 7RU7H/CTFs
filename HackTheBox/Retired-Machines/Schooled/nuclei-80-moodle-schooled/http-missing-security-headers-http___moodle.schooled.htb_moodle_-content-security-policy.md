### HTTP Missing Security Headers (http-missing-security-headers:content-security-policy) found on moodle.schooled.htb

----
**Details**: **http-missing-security-headers:content-security-policy** matched at moodle.schooled.htb
