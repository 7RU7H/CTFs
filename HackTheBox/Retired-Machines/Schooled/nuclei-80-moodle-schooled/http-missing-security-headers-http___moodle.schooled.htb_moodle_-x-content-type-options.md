### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on moodle.schooled.htb

----
**Details**: **http-missing-security-headers:x-content-type-options** matched at moodle.schooled.htb
