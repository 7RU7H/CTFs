### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on moodle.schooled.htb

----
**Details**: **http-missing-security-headers:clear-site-data** matched at moodle.schooled.htb
