### Nginx version detect (nginx-version) found on runner.htb

----
**Details**: **nginx-version** matched at runner.htb

**Protocol**: HTTP

**Full URL**: http://runner.htb

**Timestamp**: Sun Apr 21 11:05:43 +0100 BST 2024
...
Date: Sun, 21 Apr 2024 10:05:44 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4280.67 Safari/537.36 Edg/97.0.664.52' 'http://runner.htb'
```
