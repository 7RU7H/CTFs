### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on runner.htb

----
**Details**: **http-missing-security-headers:clear-site-data** matched at runner.htb
