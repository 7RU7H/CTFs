### HTTP Missing Security Headers (http-missing-security-headers:x-permitted-cross-domain-policies) found on runner.htb

----
**Details**: **http-missing-security-headers:x-permitted-cross-domain-policies** matched at runner.htb

**Protocol**: HTTP

**Full URL**: http://runner.htb

**Timestamp**: Sun Apr 21 11:06:10 +0100 BST 2024
...
Date: Sun, 21 Apr 2024 10:06:10 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:10.0) Gecko/20100101 Firefox/10.0' 'http://runner.htb'
```
