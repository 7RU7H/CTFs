### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on runner.htb

----
**Details**: **http-missing-security-headers:permissions-policy** matched at runner.htb
