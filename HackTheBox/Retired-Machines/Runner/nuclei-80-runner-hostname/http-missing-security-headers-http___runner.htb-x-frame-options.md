### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on runner.htb

----
**Details**: **http-missing-security-headers:x-frame-options** matched at runner.htb
