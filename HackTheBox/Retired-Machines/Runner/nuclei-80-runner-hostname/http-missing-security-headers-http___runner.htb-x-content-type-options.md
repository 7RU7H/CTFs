### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on runner.htb

----
**Details**: **http-missing-security-headers:x-content-type-options** matched at runner.htb
