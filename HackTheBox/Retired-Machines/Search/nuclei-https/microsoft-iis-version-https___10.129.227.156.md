### Microsoft IIS version detect (microsoft-iis-version) found on https://10.129.227.156
---
**Details**: **microsoft-iis-version**  matched at https://10.129.227.156

**Protocol**: HTTP

**Full URL**: https://10.129.227.156

**Timestamp**: Wed Dec 28 18:25:35 +0000 GMT 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2226.0 Safari/537.36' 'https://10.129.227.156'
```
---
