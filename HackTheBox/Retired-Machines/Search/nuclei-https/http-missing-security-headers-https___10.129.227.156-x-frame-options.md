### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on https://10.129.227.156
---
**Details**: **http-missing-security-headers:x-frame-options**  matched at https://10.129.227.156
