### Wappalyzer Technology Detection (tech-detect:google-font-api) found on https://10.129.227.156
---
**Details**: **tech-detect:google-font-api**  matched at https://10.129.227.156

**Protocol**: HTTP

**Full URL**: https://10.129.227.156

**Timestamp**: Wed Dec 28 18:25:34 +0000 GMT 2022
...
Date: Wed, 28 Dec 2022 18:25:28 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2224.3 Safari/537.36' 'https://10.129.227.156'
```
---
