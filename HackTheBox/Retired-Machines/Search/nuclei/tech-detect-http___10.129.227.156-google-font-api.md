### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.129.227.156
---
**Details**: **tech-detect:google-font-api**  matched at http://10.129.227.156

**Protocol**: HTTP

**Full URL**: http://10.129.227.156

**Timestamp**: Wed Dec 28 12:00:52 +0000 GMT 2022
...
Date: Wed, 28 Dec 2022 12:00:50 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://10.129.227.156'
```
---
