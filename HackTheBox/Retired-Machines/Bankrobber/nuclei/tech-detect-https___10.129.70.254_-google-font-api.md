### Wappalyzer Technology Detection (tech-detect:google-font-api) found on https://10.129.70.254/
---
**Details**: **tech-detect:google-font-api**  matched at https://10.129.70.254/

**Protocol**: HTTP

**Full URL**: https://10.129.70.254/

**Timestamp**: Sun Jun 5 20:56:03 +0100 BST 2022
...
Date: Sun, 05 Jun 2022 19:56:02 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'https://10.129.70.254/'
```
---
