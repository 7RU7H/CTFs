### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.129.70.254/
---
**Details**: **tech-detect:google-font-api**  matched at http://10.129.70.254/

**Protocol**: HTTP

**Full URL**: http://10.129.70.254/

**Timestamp**: Sun Jun 5 20:49:45 +0100 BST 2022
...
Date: Sun, 05 Jun 2022 19:49:44 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.137 Safari/4E423F' 'http://10.129.70.254/'
```
---
