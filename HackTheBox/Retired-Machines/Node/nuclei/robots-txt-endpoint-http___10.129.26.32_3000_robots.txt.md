### robots.txt endpoint prober (robots-txt-endpoint) found on http://10.129.26.32:3000
---
**Details**: **robots-txt-endpoint**  matched at http://10.129.26.32:3000

**Protocol**: HTTP

**Full URL**: http://10.129.26.32:3000/robots.txt

**Timestamp**: Fri Oct 21 20:55:34 +0100 BST 2022
...
Date: Fri, 21 Oct 2022 19:55:34 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36' 'http://10.129.26.32:3000/robots.txt'
```
---
