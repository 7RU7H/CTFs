### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on http://nineveh.htb
---
**Details**: **http-missing-security-headers:referrer-policy**  matched at http://nineveh.htb
