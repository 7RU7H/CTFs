### WAF Detection (waf-detect:apachegeneric) found on http://10.129.95.225
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.129.95.225

**Protocol**: HTTP

**Full URL**: http://10.129.95.225/

**Timestamp**: Tue Aug 16 20:44:00 +0100 BST 2022
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.95.225' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.47 Safari/537.36' 'http://10.129.95.225/'
```
---
