### HTTP Missing Security Headers (http-missing-security-headers:content-security-policy) found on mailing.htb

----
**Details**: **http-missing-security-headers:content-security-policy** matched at mailing.htb
