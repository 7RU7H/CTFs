### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on mailing.htb

----
**Details**: **http-missing-security-headers:x-frame-options** matched at mailing.htb
