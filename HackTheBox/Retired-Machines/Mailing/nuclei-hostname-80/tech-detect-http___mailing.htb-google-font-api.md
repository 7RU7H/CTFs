### Wappalyzer Technology Detection (tech-detect:google-font-api) found on mailing.htb

----
**Details**: **tech-detect:google-font-api** matched at mailing.htb

**Protocol**: HTTP

**Full URL**: http://mailing.htb

**Timestamp**: Sun May 5 17:41:48 +0100 BST 2024
...
GET / HTTP/1.1
Host: mailing.htb
User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.4 Mobile/15E148 Safari/604.1
Connection: close
Accept: */*
Accept-Language: en
...
Date: Sun, 05 May 2024 16:41:48 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.4 Mobile/15E148 Safari/604.1' 'http://mailing.htb'
```
