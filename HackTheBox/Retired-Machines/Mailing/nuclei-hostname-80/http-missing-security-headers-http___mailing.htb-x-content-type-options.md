### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on mailing.htb

----
**Details**: **http-missing-security-headers:x-content-type-options** matched at mailing.htb
