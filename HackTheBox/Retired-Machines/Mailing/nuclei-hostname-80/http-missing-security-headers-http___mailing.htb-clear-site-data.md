### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on mailing.htb

----
**Details**: **http-missing-security-headers:clear-site-data** matched at mailing.htb
