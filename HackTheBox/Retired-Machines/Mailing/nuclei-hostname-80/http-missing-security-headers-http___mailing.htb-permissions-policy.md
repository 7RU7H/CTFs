### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on mailing.htb

----
**Details**: **http-missing-security-headers:permissions-policy** matched at mailing.htb
