### Microsoft IIS version detect (microsoft-iis-version) found on mailing.htb

----
**Details**: **microsoft-iis-version** matched at mailing.htb

**Protocol**: HTTP

**Full URL**: http://mailing.htb

**Timestamp**: Sun May 5 17:42:21 +0100 BST 2024
...
Date: Sun, 05 May 2024 16:42:21 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36' 'http://mailing.htb'
```
