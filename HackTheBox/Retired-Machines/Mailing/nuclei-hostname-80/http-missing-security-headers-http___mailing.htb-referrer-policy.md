### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on mailing.htb

----
**Details**: **http-missing-security-headers:referrer-policy** matched at mailing.htb
