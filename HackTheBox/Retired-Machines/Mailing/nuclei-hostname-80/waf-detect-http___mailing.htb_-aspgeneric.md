### WAF Detection (waf-detect:aspgeneric) found on mailing.htb

----
**Details**: **waf-detect:aspgeneric** matched at mailing.htb

**Protocol**: HTTP

**Full URL**: http://mailing.htb/

**Timestamp**: Sun May 5 17:42:22 +0100 BST 2024
...
Date: Sun, 05 May 2024 16:42:22 GMT
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: mailing.htb' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64; rv:13.0) Gecko/20100101 Firefox/13.0.1' 'http://mailing.htb/'
```
