### Nginx version detect (nginx-version) found on http://stocker.htb/
---
**Details**: **nginx-version**  matched at http://stocker.htb/

**Protocol**: HTTP

**Full URL**: http://stocker.htb/

**Timestamp**: Sun Jun 25 18:25:26 +0100 BST 2023
...
Date: Sun, 25 Jun 2023 17:24:47 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.3319.102 Safari/537.36' 'http://stocker.htb/'
```
---
