### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://stocker.htb/
---
**Details**: **http-missing-security-headers:permissions-policy**  matched at http://stocker.htb/
