### Wappalyzer Technology Detection (tech-detect:nginx) found on http://stocker.htb/
---
**Details**: **tech-detect:nginx**  matched at http://stocker.htb/

**Protocol**: HTTP

**Full URL**: http://stocker.htb/

**Timestamp**: Sun Jun 25 18:25:27 +0100 BST 2023
...
Date: Sun, 25 Jun 2023 17:24:48 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1866.237 Safari/537.36' 'http://stocker.htb/'
```
---
