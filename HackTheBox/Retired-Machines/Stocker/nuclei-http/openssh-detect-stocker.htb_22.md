### OpenSSH Service - Detect (openssh-detect) found on http://stocker.htb/
---
**Details**: **openssh-detect**  matched at http://stocker.htb/

**Protocol**: TCP

**Full URL**: stocker.htb:22

**Timestamp**: Sun Jun 25 18:25:57 +0100 BST 2023
