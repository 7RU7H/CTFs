### HTTP Missing Security Headers (http-missing-security-headers:referrer-policy) found on http://stocker.htb/
---
**Details**: **http-missing-security-headers:referrer-policy**  matched at http://stocker.htb/
