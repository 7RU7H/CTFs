...
Finish 0xDF and Ippsec content ... I started here, finishing the video with [Regexes in sudoers file](https://www.youtube.com/watch?v=fWMHh8GYqJE) Prevent Wildcard abuse of sudo.
```bash
ls -la /etc/sudoers.d 
sudo vim $USER
# Instead *
...
Then I began my reading of [0xdf](https://0xdf.gitlab.io/2023/06/24/htb-stocker.html) references [Hacktricks Server Side XSS (dynamic PDF)](https://book.hacktricks.xyz/pentesting-web/xss-cross-site-scripting/server-side-xss-dynamic-pdf), which is actually a really significant as I very new to this kind of exploit on server side applications. This would be where PDFs get a bad reputation. I had no idea that PDFs were partly HTML.  
```js
...
```
 ...
 [Hacktricks Server Side XSS (dynamic PDF)](https://book.hacktricks.xyz/pentesting-web/xss-cross-site-scripting/server-side-xss-dynamic-pdf) and [PayloadAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection#xss-in-htmlapplications)
```html
