...
- Hunt for 3 more content creators for this type of learning exercise - want to do one a week to compliment start really focusing on completing one HTB Active machine a week from February. 
Learnt:
- AWS basics
- Routing possibilities on Apache config

Beyond Root:
- Harden box - Failed no time More Azure Instead
- Add a low and high Privilege Persistence + plus create a vulnerable on the box
