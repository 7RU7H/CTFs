### OpenSSH Service Detection (openssh-detect) found on http://bucket.htb
---
**Details**: **openssh-detect**  matched at http://bucket.htb

**Protocol**: NETWORK

**Full URL**: bucket.htb:22

**Timestamp**: Mon Jan 9 12:35:01 +0000 GMT 2023
