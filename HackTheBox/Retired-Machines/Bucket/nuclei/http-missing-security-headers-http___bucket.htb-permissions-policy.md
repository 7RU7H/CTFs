### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://bucket.htb
---
**Details**: **http-missing-security-headers:permissions-policy**  matched at http://bucket.htb
