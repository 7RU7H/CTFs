### Apache Detection (apache-detect) found on http://bucket.htb
---
**Details**: **apache-detect**  matched at http://bucket.htb

**Protocol**: HTTP

**Full URL**: http://bucket.htb

**Timestamp**: Mon Jan 9 12:34:51 +0000 GMT 2023
...
Date: Mon, 09 Jan 2023 12:34:51 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 4.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2049.0 Safari/537.36' 'http://bucket.htb'
```
---
