### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on http://bucket.htb
---
**Details**: **http-missing-security-headers:clear-site-data**  matched at http://bucket.htb
