### Nginx version detect (nginx-version) found on http://superpass.htb
---
**Details**: **nginx-version**  matched at http://superpass.htb

**Protocol**: HTTP

**Full URL**: http://superpass.htb

**Timestamp**: Mon Mar 6 19:58:08 +0000 GMT 2023
...
Date: Mon, 06 Mar 2023 19:58:07 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1866.237 Safari/537.36' 'http://superpass.htb'
```
---
