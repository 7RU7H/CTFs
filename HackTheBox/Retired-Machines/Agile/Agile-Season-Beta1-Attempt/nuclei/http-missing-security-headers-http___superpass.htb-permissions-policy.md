### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://superpass.htb
---
**Details**: **http-missing-security-headers:permissions-policy**  matched at http://superpass.htb
