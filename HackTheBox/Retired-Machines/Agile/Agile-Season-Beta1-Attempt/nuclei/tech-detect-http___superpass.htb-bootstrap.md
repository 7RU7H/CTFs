### Wappalyzer Technology Detection (tech-detect:bootstrap) found on http://superpass.htb
---
**Details**: **tech-detect:bootstrap**  matched at http://superpass.htb

**Protocol**: HTTP

**Full URL**: http://superpass.htb

**Timestamp**: Mon Mar 6 19:58:11 +0000 GMT 2023
...
Date: Mon, 06 Mar 2023 19:58:10 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'http://superpass.htb'
```
---
