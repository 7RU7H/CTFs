### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://soccer.htb
---
**Details**: **http-missing-security-headers:permissions-policy**  matched at http://soccer.htb
