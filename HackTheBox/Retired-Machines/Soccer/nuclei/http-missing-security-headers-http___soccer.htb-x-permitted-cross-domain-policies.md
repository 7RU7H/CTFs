### HTTP Missing Security Headers (http-missing-security-headers:x-permitted-cross-domain-policies) found on http://soccer.htb
---
**Details**: **http-missing-security-headers:x-permitted-cross-domain-policies**  matched at http://soccer.htb

**Protocol**: HTTP

**Full URL**: http://soccer.htb

**Timestamp**: Tue Mar 28 08:44:17 +0100 BST 2023
...
Date: Tue, 28 Mar 2023 07:44:16 GMT
