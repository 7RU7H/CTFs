### Nginx version detect (nginx-version) found on http://soccer.htb
---
**Details**: **nginx-version**  matched at http://soccer.htb
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36' 'http://soccer.htb'
```
---
