### Wappalyzer Technology Detection (tech-detect:lighttpd) found on https://10.129.127.63
---
**Details**: **tech-detect:lighttpd**  matched at https://10.129.127.63

**Protocol**: HTTP

**Full URL**: https://10.129.127.63

**Timestamp**: Fri Sep 2 08:18:37 +0100 BST 2022
...
Set-Cookie: PHPSESSID=b659822cff434dd2b03f9e8ac11c2a72; path=/; secure; HttpOnly
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.124 Safari/537.36' 'https://10.129.127.63'
```
---
