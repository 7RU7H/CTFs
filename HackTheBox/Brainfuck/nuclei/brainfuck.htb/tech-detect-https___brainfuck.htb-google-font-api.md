### Wappalyzer Technology Detection (tech-detect:google-font-api) found on https://brainfuck.htb
---
**Details**: **tech-detect:google-font-api**  matched at https://brainfuck.htb

**Protocol**: HTTP

**Full URL**: https://brainfuck.htb

**Timestamp**: Wed Aug 17 20:46:43 +0100 BST 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; OpenBSD i386) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.125 Safari/537.36' 'https://brainfuck.htb'
```
---
