### HTTP Missing Security Headers (http-missing-security-headers:permission-policy) found on https://brainfuck.htb
---
**Details**: **http-missing-security-headers:permission-policy**  matched at https://brainfuck.htb
