### HTTP Missing Security Headers (http-missing-security-headers:permission-policy) found on https://10.129.1.1
---
**Details**: **http-missing-security-headers:permission-policy**  matched at https://10.129.1.1
