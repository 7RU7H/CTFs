### Microsoft IIS version detect (microsoft-iis-version) found on http://10.129.169.203:8080
---
**Details**: **microsoft-iis-version**  matched at http://10.129.169.203:8080
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2225.0 Safari/537.36' 'http://10.129.169.203:8080'
```
---
