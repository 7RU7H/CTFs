### Wappalyzer Technology Detection (tech-detect:bootstrap) found on http://10.129.95.225
---
**Details**: **tech-detect:bootstrap**  matched at http://10.129.95.225

**Protocol**: HTTP

**Full URL**: http://10.129.95.225

**Timestamp**: Tue Aug 16 20:43:43 +0100 BST 2022
...
Date: Tue, 16 Aug 2022 19:43:42 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://10.129.95.225'
```
---
