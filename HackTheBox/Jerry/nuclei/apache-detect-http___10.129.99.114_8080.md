### Apache Detection (apache-detect) found on http://10.129.99.114:8080
---
**Details**: **apache-detect**  matched at http://10.129.99.114:8080

**Protocol**: HTTP

**Full URL**: http://10.129.99.114:8080

**Timestamp**: Tue May 31 09:11:21 +0100 BST 2022
...
Date: Tue, 31 May 2022 15:11:21 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 4.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2049.0 Safari/537.36' 'http://10.129.99.114:8080'
```
---
