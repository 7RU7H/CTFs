### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on https://10.129.96.140
---
**Details**: **http-missing-security-headers:x-frame-options**  matched at https://10.129.96.140
