### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://10.129.64.97
---
**Details**: **tech-detect:google-font-api**  matched at http://10.129.64.97

**Protocol**: HTTP

**Full URL**: http://10.129.64.97

**Timestamp**: Wed Aug 3 14:52:06 +0100 BST 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://10.129.64.97'
```
---
