### WAF Detection (waf-detect:apachegeneric) found on https://10.129.70.254/
---
**Details**: **waf-detect:apachegeneric**  matched at https://10.129.70.254/

**Protocol**: HTTP

**Full URL**: https://10.129.70.254/

**Timestamp**: Sun Jun 5 20:56:59 +0100 BST 2022
...
Date: Sun, 05 Jun 2022 19:56:58 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.129.70.254' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'https://10.129.70.254/'
```
---
