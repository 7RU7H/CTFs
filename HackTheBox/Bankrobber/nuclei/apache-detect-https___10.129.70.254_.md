### Apache Detection (apache-detect) found on https://10.129.70.254/
---
**Details**: **apache-detect**  matched at https://10.129.70.254/
...
Date: Sun, 05 Jun 2022 19:56:01 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2117.157 Safari/537.36' 'https://10.129.70.254/'
```
---
