### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on https://10.129.70.254/
---
**Details**: **http-missing-security-headers:x-frame-options**  matched at https://10.129.70.254/
