### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on https://10.129.70.254/
---
**Details**: **http-missing-security-headers:x-content-type-options**  matched at https://10.129.70.254/
