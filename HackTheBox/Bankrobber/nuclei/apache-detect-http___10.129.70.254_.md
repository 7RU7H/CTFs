### Apache Detection (apache-detect) found on http://10.129.70.254/
---
**Details**: **apache-detect**  matched at http://10.129.70.254/

**Protocol**: HTTP

**Full URL**: http://10.129.70.254/

**Timestamp**: Sun Jun 5 20:49:44 +0100 BST 2022
...
Date: Sun, 05 Jun 2022 19:49:43 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1944.0 Safari/537.36' 'http://10.129.70.254/'
```
---
