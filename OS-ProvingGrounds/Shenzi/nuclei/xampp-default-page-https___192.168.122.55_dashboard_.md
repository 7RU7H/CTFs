### XAMPP Default Page (xampp-default-page) found on https://192.168.122.55
---
**Details**: **xampp-default-page**  matched at https://192.168.122.55

**Protocol**: HTTP

**Full URL**: https://192.168.122.55/dashboard/

**Timestamp**: Thu Jul 28 19:32:08 +0100 BST 2022
...
Date: Thu, 28 Jul 2022 18:32:08 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2656.18 Safari/537.36' 'https://192.168.122.55/dashboard/'
```
---
