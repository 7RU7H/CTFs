### Wappalyzer Technology Detection (tech-detect:bootstrap) found on http://192.168.141.62
---
**Details**: **tech-detect:bootstrap**  matched at http://192.168.141.62

**Protocol**: HTTP

**Full URL**: http://192.168.141.62

**Timestamp**: Sat Sep 17 21:53:56 +0100 BST 2022
...
Date: Sat, 17 Sep 2022 20:53:56 GMT
Server: nginx/1.16.1
Vary: Cookie
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2762.73 Safari/537.36' 'http://192.168.141.62'
```
---
