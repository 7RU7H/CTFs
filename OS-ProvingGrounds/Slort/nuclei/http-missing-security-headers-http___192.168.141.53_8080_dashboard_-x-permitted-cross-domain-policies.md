### HTTP Missing Security Headers (http-missing-security-headers:x-permitted-cross-domain-policies) found on http://192.168.141.53:8080
---
**Details**: **http-missing-security-headers:x-permitted-cross-domain-policies**  matched at http://192.168.141.53:8080

**Protocol**: HTTP

**Full URL**: http://192.168.141.53:8080/dashboard/

**Timestamp**: Fri Sep 23 10:53:03 +0100 BST 2022
...
Date: Fri, 23 Sep 2022 09:53:03 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'Referer: http://192.168.141.53:8080' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2117.157 Safari/537.36' 'http://192.168.141.53:8080/dashboard/'
```
---
