### Apache Detection (apache-detect) found on http://192.168.232.53:4443/dashboard/

----
**Details**: **apache-detect** matched at http://192.168.232.53:4443/dashboard/

**Protocol**: HTTP

**Full URL**: http://192.168.232.53:4443/dashboard/

**Timestamp**: Fri Nov 3 21:02:28 +0000 GMT 2023
...
Date: Fri, 03 Nov 2023 21:02:14 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2309.372 Safari/537.36' 'http://192.168.232.53:4443/dashboard/'
```
