### XAMPP Default Page (xampp-default-page) found on http://192.168.141.53:8080
---
**Details**: **xampp-default-page**  matched at http://192.168.141.53:8080

**Protocol**: HTTP

**Full URL**: http://192.168.141.53:8080/dashboard/

**Timestamp**: Fri Sep 23 10:53:07 +0100 BST 2022
...
Date: Fri, 23 Sep 2022 09:53:07 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.77 Safari/537.36' 'http://192.168.141.53:8080/dashboard/'
```
---
