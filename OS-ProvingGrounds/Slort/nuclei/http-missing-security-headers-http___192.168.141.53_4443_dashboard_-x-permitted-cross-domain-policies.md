### HTTP Missing Security Headers (http-missing-security-headers:x-permitted-cross-domain-policies) found on http://192.168.141.53:4443
---
**Details**: **http-missing-security-headers:x-permitted-cross-domain-policies**  matched at http://192.168.141.53:4443

**Protocol**: HTTP

**Full URL**: http://192.168.141.53:4443/dashboard/

**Timestamp**: Fri Sep 23 10:24:09 +0100 BST 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'Referer: http://192.168.141.53:4443' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'http://192.168.141.53:4443/dashboard/'
```
---
