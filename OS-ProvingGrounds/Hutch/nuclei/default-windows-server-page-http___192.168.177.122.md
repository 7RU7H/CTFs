### IIS Windows Server Default Page (default-windows-server-page) found on http://192.168.177.122
---
**Details**: **default-windows-server-page**  matched at http://192.168.177.122
