### HTTP Missing Security Headers (http-missing-security-headers:x-permitted-cross-domain-policies) found on http://192.168.217.41/test/

----
**Details**: **http-missing-security-headers:x-permitted-cross-domain-policies** matched at http://192.168.217.41/test/

**Protocol**: HTTP

**Full URL**: http://192.168.217.41/test/

**Timestamp**: Sat Nov 11 19:44:39 +0000 GMT 2023
...
Date: Sun, 12 Nov 2023 00:44:21 GMT
Last-Modified: Sun, 12 Nov 2023 00:44:21 GMT
Server: Apache/2.2.14 (Ubuntu)
Set-Cookie: zenphoto_auth=deleted; expires=Sat, 12-Nov-2022 00:44:21 GMT; path=/test
Set-Cookie: zenphoto_ssl=deleted; expires=Sat, 12-Nov-2022 00:44:21 GMT; path=/test
Status: 200 OK
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'http://192.168.217.41/test/'
```
