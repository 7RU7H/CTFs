### Host Header Injection (host-header-injection) found on http://192.168.217.41/test/

----
**Details**: **host-header-injection** matched at http://192.168.217.41/test/

**Protocol**: HTTP

**Full URL**: http://192.168.217.41/test/

**Timestamp**: Sat Nov 11 19:44:44 +0000 GMT 2023
...
```http
GET /test/ HTTP/1.1
Host: 2Y2m4uZlWKCTc9IlWiYx34QRhcq.tld
...
Date: Sun, 12 Nov 2023 00:44:26 GMT
Last-Modified: Sun, 12 Nov 2023 00:44:26 GMT
Server: Apache/2.2.14 (Ubuntu)
Set-Cookie: zenphoto_auth=deleted; expires=Sat, 12-Nov-2022 00:44:25 GMT; path=/test
Set-Cookie: zenphoto_ssl=deleted; expires=Sat, 12-Nov-2022 00:44:25 GMT; path=/test
Status: 200 OK
...
<head>
	...
	<link rel="alternate" type="application/rss+xml" title="Gallery RSS" href="http://2Y2m4uZlWKCTc9IlWiYx34QRhcq.tld/test/index.php?rss&amp;lang=en_US" />
</head>
...
<div id="credit">
<a  href="/test/index.php?rss&amp;lang=en_US" title="Latest images RSS" rel="nofollow">RSS <img src="http://2Y2m4uZlWKCTc9IlWiYx34QRhcq.tld/test/zp-core/images/rss.png" alt="RSS Feed" /></a> | <a href="/test/index.php?p=archive"  title="Archive View">Archive View</a> |


Powered by <a href="http://www.zenphoto.org" title="A simpler web album"><span id="zen-part">zen</span><span id.... Truncated ....
```
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'Host: 2Y2m4uZlWKCTc9IlWiYx34QRhcq.tld' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.47 Safari/537.36' 'http://192.168.217.41/test/'
```
