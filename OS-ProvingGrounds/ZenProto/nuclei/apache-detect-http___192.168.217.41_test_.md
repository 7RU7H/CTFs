### Apache Detection (apache-detect) found on http://192.168.217.41/test/

----
**Details**: **apache-detect** matched at http://192.168.217.41/test/

**Protocol**: HTTP

**Full URL**: http://192.168.217.41/test/

**Timestamp**: Sat Nov 11 19:44:30 +0000 GMT 2023
...
Date: Sun, 12 Nov 2023 00:44:12 GMT
Last-Modified: Sun, 12 Nov 2023 00:44:12 GMT
Server: Apache/2.2.14 (Ubuntu)
Set-Cookie: zenphoto_auth=deleted; expires=Sat, 12-Nov-2022 00:44:11 GMT; path=/test
Set-Cookie: zenphoto_ssl=deleted; expires=Sat, 12-Nov-2022 00:44:11 GMT; path=/test
Status: 200 OK
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.1 Safari/537.36' 'http://192.168.217.41/test/'
```
