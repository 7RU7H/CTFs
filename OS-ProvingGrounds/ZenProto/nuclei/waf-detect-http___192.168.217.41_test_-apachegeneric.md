### WAF Detection (waf-detect:apachegeneric) found on http://192.168.217.41/test/

----
**Details**: **waf-detect:apachegeneric** matched at http://192.168.217.41/test/

**Protocol**: HTTP

**Full URL**: http://192.168.217.41/test/

**Timestamp**: Sat Nov 11 19:44:51 +0000 GMT 2023
...
Date: Sun, 12 Nov 2023 00:44:33 GMT
Last-Modified: Sun, 12 Nov 2023 00:44:33 GMT
Server: Apache/2.2.14 (Ubuntu)
Set-Cookie: zenphoto_auth=deleted; expires=Sat, 12-Nov-2022 00:44:32 GMT; path=/test
Set-Cookie: zenphoto_ssl=deleted; expires=Sat, 12-Nov-2022 00:44:32 GMT; path=/test
Status: 200 OK
...
<head>
	...
	<link rel="alternate" type="application/rss+xml" title="Gallery RSS" href="http://192.168.217.41/test/index.php?rss&amp;lang=" />
</head>
...
<div id="credit">
<a  href="/test/index.php?rss&amp;lang=" title="Latest images RSS" rel="nofollow">RSS <img src="http://192.168.217.41/test/zp-core/images/rss.png" alt="RSS Feed" /></a> | <a href="/test/index.php?p=archive"  title="Archive View">Archive View</a> |
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 192.168.217.41' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2049.0 Safari/537.36' 'http://192.168.217.41/test/'
```
