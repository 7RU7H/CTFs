### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://192.168.226.58
---
**Details**: **tech-detect:google-font-api**  matched at http://192.168.226.58
...
Date: Tue, 06 Sep 2022 10:37:44 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2225.0 Safari/537.36' 'http://192.168.226.58'
```
---
