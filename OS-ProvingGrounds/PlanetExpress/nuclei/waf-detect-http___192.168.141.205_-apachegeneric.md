### WAF Detection (waf-detect:apachegeneric) found on http://192.168.141.205
---
**Details**: **waf-detect:apachegeneric**  matched at http://192.168.141.205

**Protocol**: HTTP

**Full URL**: http://192.168.141.205/

**Timestamp**: Tue Sep 20 19:05:37 +0100 BST 2022
...
Date: Tue, 20 Sep 2022 18:05:37 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 192.168.141.205' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.67 Safari/537.36' 'http://192.168.141.205/'
```
---
