### Wappalyzer Technology Detection (tech-detect:nginx) found on http://192.168.125.143
---
**Details**: **tech-detect:nginx**  matched at http://192.168.125.143

**Protocol**: HTTP

**Full URL**: http://192.168.125.143

**Timestamp**: Sat Oct 15 16:40:59 +0100 BST 2022
...
Date: Sat, 15 Oct 2022 15:39:49 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2820.59 Safari/537.36' 'http://192.168.125.143'
```
---
