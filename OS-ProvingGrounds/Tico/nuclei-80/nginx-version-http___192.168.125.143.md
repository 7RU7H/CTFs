### Nginx version detect (nginx-version) found on http://192.168.125.143
---
**Details**: **nginx-version**  matched at http://192.168.125.143
...
Date: Sat, 15 Oct 2022 15:39:48 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.3319.102 Safari/537.36' 'http://192.168.125.143'
```
---
