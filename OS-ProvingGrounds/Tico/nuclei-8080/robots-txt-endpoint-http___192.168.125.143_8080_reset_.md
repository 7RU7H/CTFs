...
**Full URL**: http://192.168.125.143:8080/reset/

**Timestamp**: Sat Oct 15 16:45:04 +0100 BST 2022
...
Date: Sat, 15 Oct 2022 15:43:53 GMT
Etag: W/"4173-MV3PebYkK1Rn8aHo5iDAXpEpgWo"
Referrer-Policy: strict-origin-when-cross-origin
Set-Cookie: _csrf=X1rLGNSI3f-uF54frEnVteUl; Path=/
...
<head>
	<title>Reset your account password | NodeBB</title>
	...
	<meta property="og:url" content="http://localhost:4567/reset/" />
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.3319.102 Safari/537.36' 'http://192.168.125.143:8080/reset/'
```
---
