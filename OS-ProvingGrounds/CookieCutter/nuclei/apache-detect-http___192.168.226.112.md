### Apache Detection (apache-detect) found on http://192.168.226.112
---
**Details**: **apache-detect**  matched at http://192.168.226.112
...
Date: Sun, 04 Sep 2022 21:34:59 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36' 'http://192.168.226.112'
```
---
