### WAF Detection (waf-detect:apachegeneric) found on http://192.168.226.112
---
**Details**: **waf-detect:apachegeneric**  matched at http://192.168.226.112

**Protocol**: HTTP

**Full URL**: http://192.168.226.112/

**Timestamp**: Sun Sep 4 22:35:52 +0100 BST 2022
...
Date: Sun, 04 Sep 2022 21:36:07 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 192.168.226.112' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://192.168.226.112/'
```
---
