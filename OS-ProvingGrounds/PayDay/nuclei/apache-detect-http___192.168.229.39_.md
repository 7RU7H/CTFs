### Apache Detection (apache-detect) found on http://192.168.229.39/

----
**Details**: **apache-detect** matched at http://192.168.229.39/

**Protocol**: HTTP

**Full URL**: http://192.168.229.39/

**Timestamp**: Wed Nov 15 12:04:54 +0000 GMT 2023
...
Date: Wed, 15 Nov 2023 12:04:35 GMT
Expires: -1
Last-Modified: Wed, 15 Nov 2023 12:04:35 GMT
Pragma: no-cache
Server: Apache/2.2.4 (Ubuntu) PHP/5.2.3-1ubuntu6
Set-Cookie: csid=aff28318826ed6cff82af692dda9c240; expires=Wed, 15-Nov-2023 14:04:35 GMT; path=/; domain=.192.168.229.39
Set-Cookie: csid=aff28318826ed6cff82af692dda9c240; path=/; domain=.192.168.229.39
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2309.372 Safari/537.36' 'http://192.168.229.39/'
```
