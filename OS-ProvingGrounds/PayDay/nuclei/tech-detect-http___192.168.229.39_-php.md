### Wappalyzer Technology Detection (tech-detect:php) found on http://192.168.229.39/

----
**Details**: **tech-detect:php** matched at http://192.168.229.39/

**Protocol**: HTTP

**Full URL**: http://192.168.229.39/

**Timestamp**: Wed Nov 15 12:04:55 +0000 GMT 2023
...
Date: Wed, 15 Nov 2023 12:04:37 GMT
Expires: -1
Last-Modified: Wed, 15 Nov 2023 12:04:37 GMT
Pragma: no-cache
Server: Apache/2.2.4 (Ubuntu) PHP/5.2.3-1ubuntu6
Set-Cookie: csid=4e556de3f9421ebf843b1ebd7732aedd; expires=Wed, 15-Nov-2023 14:04:37 GMT; path=/; domain=.192.168.229.39
Set-Cookie: csid=4e556de3f9421ebf843b1ebd7732aedd; path=/; domain=.192.168.229.39
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2866.71 Safari/537.36' 'http://192.168.229.39/'
```
