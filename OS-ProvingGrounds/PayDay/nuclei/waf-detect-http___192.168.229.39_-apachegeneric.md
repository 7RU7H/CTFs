### WAF Detection (waf-detect:apachegeneric) found on http://192.168.229.39/

----
**Details**: **waf-detect:apachegeneric** matched at http://192.168.229.39/

**Protocol**: HTTP

**Full URL**: http://192.168.229.39/

**Timestamp**: Wed Nov 15 12:08:24 +0000 GMT 2023
...
Date: Wed, 15 Nov 2023 12:08:06 GMT
Expires: -1
Last-Modified: Wed, 15 Nov 2023 12:08:06 GMT
Pragma: no-cache
Server: Apache/2.2.4 (Ubuntu) PHP/5.2.3-1ubuntu6
Set-Cookie: csid=953b097e62107b7f91104adf8504ef64; expires=Wed, 15-Nov-2023 14:08:06 GMT; path=/; domain=.192.168.229.39
Set-Cookie: csid=953b097e62107b7f91104adf8504ef64; path=/; domain=.192.168.229.39
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 192.168.229.39' -H 'User-Agent: Mozilla/5.0 (Windows NT 4.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2049.0 Safari/537.36' 'http://192.168.229.39/'
```
