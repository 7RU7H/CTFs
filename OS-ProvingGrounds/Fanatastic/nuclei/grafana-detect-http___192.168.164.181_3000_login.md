### Grafana panel detect (grafana-detect) found on http://192.168.164.181:3000
---
**Details**: **grafana-detect**  matched at http://192.168.164.181:3000

**Protocol**: HTTP

**Full URL**: http://192.168.164.181:3000/login

**Timestamp**: Thu Jun 2 10:12:22 +0100 BST 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.3319.102 Safari/537.36' 'http://192.168.164.181:3000/login'
```
---
