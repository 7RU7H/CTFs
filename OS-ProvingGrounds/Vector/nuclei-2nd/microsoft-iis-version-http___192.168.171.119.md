### Microsoft IIS version detect (microsoft-iis-version) found on http://192.168.171.119

----
**Details**: **microsoft-iis-version** matched at http://192.168.171.119
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2762.73 Safari/537.36' 'http://192.168.171.119'
```
