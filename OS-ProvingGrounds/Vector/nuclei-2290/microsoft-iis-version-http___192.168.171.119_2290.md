### Microsoft IIS version detect (microsoft-iis-version) found on http://192.168.171.119:2290

----
**Details**: **microsoft-iis-version** matched at http://192.168.171.119:2290

**Protocol**: HTTP

**Full URL**: http://192.168.171.119:2290

**Timestamp**: Tue Nov 7 11:52:24 +0000 GMT 2023
...
Date: Tue, 07 Nov 2023 11:52:07 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.67 Safari/537.36' 'http://192.168.171.119:2290'
```
