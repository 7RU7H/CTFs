### HTTP Missing Security Headers (http-missing-security-headers:clear-site-data) found on http://notes.pg
---
**Details**: **http-missing-security-headers:clear-site-data**  matched at http://notes.pg
