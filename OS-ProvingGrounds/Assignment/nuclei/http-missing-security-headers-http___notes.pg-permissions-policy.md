### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on http://notes.pg
---
**Details**: **http-missing-security-headers:permissions-policy**  matched at http://notes.pg
