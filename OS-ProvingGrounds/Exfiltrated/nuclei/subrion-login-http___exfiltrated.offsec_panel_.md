### Subrion Admin Login Panel (subrion-login) found on http://exfiltrated.offsec
---
**Details**: **subrion-login**  matched at http://exfiltrated.offsec

**Protocol**: HTTP

**Full URL**: http://exfiltrated.offsec/panel/

**Timestamp**: Mon Sep 26 20:21:32 +0100 BST 2022
...
Date: Mon, 26 Sep 2022 19:21:44 GMT
Expires: Thu, 19 Nov 1981 08:52:00 GMT
Pragma: no-cache
Server: Apache/2.4.41 (Ubuntu)
Set-Cookie: INTELLI_06c8042c3d=b336omr0vde9lu26p772fn6m3h; path=/
Set-Cookie: INTELLI_06c8042c3d=b336omr0vde9lu26p772fn6m3h; expires=Mon, 26-Sep-2022 19:51:44 GMT; Max-Age=1800; path=/
...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Access denied :: Powered by Subrion 4.2</title>
                ...
                <div class="b-login__form">
                    <div class="login-body">
                        ...
                        <form method="post" class="sap-form">
                            <input type="hidden" name="__st" value="wzn6nRFN2RDhZ2Yx866G0kI5CNAt0LAIbuV3sGXQ">
                            <p>
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'Referer: http://exfiltrated.offsec/panel' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.47 Safari/537.36' 'http://exfiltrated.offsec/panel/'
```
---
