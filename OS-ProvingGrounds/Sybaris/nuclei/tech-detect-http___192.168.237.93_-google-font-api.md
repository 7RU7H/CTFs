### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://192.168.237.93/

----
**Details**: **tech-detect:google-font-api** matched at http://192.168.237.93/

**Protocol**: HTTP

**Full URL**: http://192.168.237.93/

**Timestamp**: Thu Oct 26 15:38:17 +0100 BST 2023
...
Set-Cookie: PHPSESSID=1ck1vnn6ea63026g5hikctid5f; path=/
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2656.18 Safari/537.36' 'http://192.168.237.93/'
```
