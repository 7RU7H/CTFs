### WAF Detection (waf-detect:apachegeneric) found on http://192.168.141.207
---
**Details**: **waf-detect:apachegeneric**  matched at http://192.168.141.207

**Protocol**: HTTP

**Full URL**: http://192.168.141.207/

**Timestamp**: Wed Sep 21 20:22:49 +0100 BST 2022
...
Date: Wed, 21 Sep 2022 19:22:49 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 192.168.141.207' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36' 'http://192.168.141.207/'
```
---
