### Apache Detection (apache-detect) found on http://192.168.141.207
---
**Details**: **apache-detect**  matched at http://192.168.141.207

**Protocol**: HTTP

**Full URL**: http://192.168.141.207

**Timestamp**: Wed Sep 21 20:22:28 +0100 BST 2022
...
Date: Wed, 21 Sep 2022 19:22:28 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.1 Safari/537.36' 'http://192.168.141.207'
```
---
