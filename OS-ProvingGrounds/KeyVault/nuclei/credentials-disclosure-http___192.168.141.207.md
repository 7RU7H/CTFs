### Credentials Disclosure Check (credentials-disclosure) found on http://192.168.141.207
---
**Details**: **credentials-disclosure**  matched at http://192.168.141.207

**Protocol**: HTTP

**Full URL**: http://192.168.141.207

**Timestamp**: Wed Sep 21 20:22:31 +0100 BST 2022
...
| Authors | sy3omda, forgedhallpass, geeknik |
...
Date: Wed, 21 Sep 2022 19:22:30 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; OpenBSD i386) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.125 Safari/537.36' 'http://192.168.141.207'
```
---
