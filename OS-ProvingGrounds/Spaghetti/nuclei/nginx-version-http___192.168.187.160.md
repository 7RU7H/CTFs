### Nginx version detect (nginx-version) found on http://192.168.187.160
---
**Details**: **nginx-version**  matched at http://192.168.187.160

**Protocol**: HTTP

**Full URL**: http://192.168.187.160

**Timestamp**: Tue May 31 13:54:02 +0100 BST 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'http://192.168.187.160'
```
---
