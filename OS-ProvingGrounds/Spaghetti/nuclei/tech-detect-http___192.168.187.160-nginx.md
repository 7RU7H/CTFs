### Wappalyzer Technology Detection (tech-detect:nginx) found on http://192.168.187.160
---
**Details**: **tech-detect:nginx**  matched at http://192.168.187.160
...
Date: Tue, 31 May 2022 12:54:01 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.4; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2225.0 Safari/537.36' 'http://192.168.187.160'
```
---
