### WAF Detection (waf-detect:apachegeneric) found on http://192.168.120.174
---
**Details**: **waf-detect:apachegeneric**  matched at http://192.168.120.174

**Protocol**: HTTP

**Full URL**: http://192.168.120.174/

**Timestamp**: Thu May 26 22:27:54 +0100 BST 2022
...
Date: Thu, 26 May 2022 21:27:54 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 192.168.120.174' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36' 'http://192.168.120.174/'
```
---
