### DOM EventListener detection (addeventlistener-detect) found on http://192.168.120.174
---
**Details**: **addeventlistener-detect**  matched at http://192.168.120.174
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2820.59 Safari/537.36' 'http://192.168.120.174'
```
---
