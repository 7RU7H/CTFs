### Missing Subresource Integrity (missing-sri) found on http://192.168.180.169/

----
**Details**: **missing-sri** matched at http://192.168.180.169/

**Protocol**: HTTP

**Full URL**: http://192.168.180.169/

**Timestamp**: Sun Nov 5 21:26:10 +0000 GMT 2023
...
Date: Sun, 05 Nov 2023 21:26:10 GMT
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Host: 192.168.180.169' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.67 Safari/537.36' 'http://192.168.180.169/'
```
