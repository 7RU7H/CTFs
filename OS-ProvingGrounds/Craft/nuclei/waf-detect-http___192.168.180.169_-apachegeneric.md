### WAF Detection (waf-detect:apachegeneric) found on http://192.168.180.169/

----
**Details**: **waf-detect:apachegeneric** matched at http://192.168.180.169/

**Protocol**: HTTP

**Full URL**: http://192.168.180.169/

**Timestamp**: Sun Nov 5 21:26:19 +0000 GMT 2023
...
Date: Sun, 05 Nov 2023 21:26:18 GMT
...
**CURL command**
```sh
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 192.168.180.169' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2224.3 Safari/537.36' 'http://192.168.180.169/'
```
