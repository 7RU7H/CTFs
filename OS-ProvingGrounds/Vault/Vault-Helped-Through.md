...
I decided review that the best course of action was to not Beyond Root this box as my intended Beyond Root were not really possible in a time requirements. To get proof.txt we need to abuse the privileges anyway.