### Web Config file (web-config) found on http://192.168.249.110
---
**Details**: **web-config**  matched at http://192.168.249.110

**Protocol**: HTTP

**Full URL**: http://192.168.249.110/web.config

**Timestamp**: Thu Jun 2 07:53:20 +0100 BST 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2309.372 Safari/537.36' 'http://192.168.249.110/web.config'
```
---
