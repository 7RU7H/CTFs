### Apache Detection (apache-detect) found on http://192.168.141.115
---
**Details**: **apache-detect**  matched at http://192.168.141.115
...
Set-Cookie: OSTSESSID=5k5ghg91o7q4dduaal6ero59lj; expires=Sat, 01-Oct-2022 07:26:50 GMT; Max-Age=86400; path=/
...
<head>
	...
	<meta name="csrf_token" content="f96e66c176462a4ac7000a1fdf9383a4ee04f674" />
</head>
<body>
    <div id="container">
        <div id="header">
...
- Apache/2.4.6 (CentOS) PHP/7.3.23



**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2224.3 Safari/537.36' 'http://192.168.141.115'
```
---
