### Wappalyzer Technology Detection (tech-detect:font-awesome) found on http://192.168.141.115
---
**Details**: **tech-detect:font-awesome**  matched at http://192.168.141.115

**Protocol**: HTTP

**Full URL**: http://192.168.141.115

**Timestamp**: Fri Sep 30 08:26:50 +0100 BST 2022
...
Date: Fri, 30 Sep 2022 07:26:50 GMT
Expires: Thu, 19 Nov 1981 08:52:00 GMT
Pragma: no-cache
Server: Apache/2.4.6 (CentOS) PHP/7.3.23
Set-Cookie: OSTSESSID=2soa5aeb93sqa8685dd92pb5do; expires=Sat, 01-Oct-2022 07:26:50 GMT; Max-Age=86400; path=/
...
<head>
	...
	<meta name="csrf_token" content="81d4f8f6c827e809ba29a733e34528b039aea5b8" />
</head>
<body>
    <div id="container">
        <div id="header">
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.2117.157 Safari/537.36' 'http://192.168.141.115'
```
---
