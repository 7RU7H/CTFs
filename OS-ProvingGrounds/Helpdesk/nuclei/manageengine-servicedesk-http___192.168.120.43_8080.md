### ZOHO ManageEngine ServiceDesk (manageengine-servicedesk) found on http://192.168.120.43:8080
---
**Details**: **manageengine-servicedesk**  matched at http://192.168.120.43:8080
...
Set-Cookie: JSESSIONID=C3470806432B80AD2DCBA7281167B6F9; Path=/
...
<html>
	...
	<body onLoad="setFocus();loadLogin(false);">
		<div id='loginDiv'  style=''>
	        <form action='j_security_check;jsessionid=C3470806432B80AD2DCBA7281167B6F9' method="post" name='login' AUTOCOMPLETE="off">			
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'http://192.168.120.43:8080'
```
---
