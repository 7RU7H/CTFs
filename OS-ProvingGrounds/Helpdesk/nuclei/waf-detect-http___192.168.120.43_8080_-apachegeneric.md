### WAF Detection (waf-detect:apachegeneric) found on http://192.168.120.43:8080
---
**Details**: **waf-detect:apachegeneric**  matched at http://192.168.120.43:8080

**Protocol**: HTTP

**Full URL**: http://192.168.120.43:8080/

**Timestamp**: Thu May 26 21:49:36 +0100 BST 2022
...
Date: Thu, 26 May 2022 20:49:35 GMT
Server: Apache-Coyote/1.1
Set-Cookie: JSESSIONID=A4578DB4F33FE96647376B477BD8274C; Path=/
...
<html>
	...
	<body onLoad="setFocus();loadLogin(false);">
		<div id='loginDiv'  style=''>
	        <form action='j_security_check;jsessionid=A4578DB4F33FE96647376B477BD8274C' method="post" name='login' AUTOCOMPLETE="off">			
	...
	<tr>
		...
		<td class="helptool-shadow-br"> </td>
				...
				<input name="hidden" type="hidden" id="choosedomain" value='Select a Domain'/>
                              ...
                              <input name="hidden" type="hidden" id="ford.... Truncated ....
```
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 192.168.120.43:8080' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.1 Safari/537.36' 'http://192.168.120.43:8080/'
```
---
