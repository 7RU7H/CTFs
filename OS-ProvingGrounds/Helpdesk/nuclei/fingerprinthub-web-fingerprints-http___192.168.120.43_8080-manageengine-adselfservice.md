### FingerprintHub Technology Fingerprint (fingerprinthub-web-fingerprints:manageengine-adselfservice) found on http://192.168.120.43:8080
---
**Details**: **fingerprinthub-web-fingerprints:manageengine-adselfservice**  matched at http://192.168.120.43:8080

**Protocol**: HTTP

**Full URL**: http://192.168.120.43:8080

**Timestamp**: Thu May 26 21:48:26 +0100 BST 2022
...
Date: Thu, 26 May 2022 20:48:26 GMT
Expires: Wed, 31 Dec 1969 16:00:00 PST
Pragma: No-cache
Server: Apache-Coyote/1.1
Set-Cookie: JSESSIONID=284D93D29F65B76D76F25E1C7A3FB158; Path=/
...
<html>
	...
	<body onLoad="setFocus();loadLogin(false);">
		<div id='loginDiv'  style=''>
	        <form action='j_security_check;jsessionid=284D93D29F65B76D76F25E1C7A3FB158' method="post" name='login' AUTOCOMPLETE="off">			
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2762.73 Safari/537.36' 'http://192.168.120.43:8080'
```
---
