### Wappalyzer Technology Detection (tech-detect:ms-iis) found on http://192.168.205.61/

----
**Details**: **tech-detect:ms-iis** matched at http://192.168.205.61/
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2225.0 Safari/537.36' 'http://192.168.205.61/'
```
