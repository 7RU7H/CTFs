### Microsoft IIS version detect (microsoft-iis-version) found on http://192.168.205.61/

----
**Details**: **microsoft-iis-version** matched at http://192.168.205.61/

**Protocol**: HTTP

**Full URL**: http://192.168.205.61/

**Timestamp**: Thu Oct 12 11:18:14 +0100 BST 2023
...
Date: Thu, 12 Oct 2023 10:17:53 GMT
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.4; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2225.0 Safari/537.36' 'http://192.168.205.61/'
```
