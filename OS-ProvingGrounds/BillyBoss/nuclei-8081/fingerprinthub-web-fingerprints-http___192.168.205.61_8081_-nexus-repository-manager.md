### FingerprintHub Technology Fingerprint (fingerprinthub-web-fingerprints:nexus-repository-manager) found on http://192.168.205.61:8081/

----
**Details**: **fingerprinthub-web-fingerprints:nexus-repository-manager** matched at http://192.168.205.61:8081/

**Protocol**: HTTP

**Full URL**: http://192.168.205.61:8081/

**Timestamp**: Thu Oct 12 11:37:30 +0100 BST 2023
...
Date: Thu, 12 Oct 2023 10:37:08 GMT
Expires: 0
Last-Modified: Thu, 12 Oct 2023 10:37:08 GMT
Pragma: no-cache
...
**CURL command**
```sh
curl -X 'GET' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36' 'http://192.168.205.61:8081/'
```
