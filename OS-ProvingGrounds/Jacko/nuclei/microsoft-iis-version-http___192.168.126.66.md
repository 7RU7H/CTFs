### Microsoft IIS version detect (microsoft-iis-version) found on http://192.168.126.66
---
**Details**: **microsoft-iis-version**  matched at http://192.168.126.66
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1866.237 Safari/537.36' 'http://192.168.126.66'
```
---
