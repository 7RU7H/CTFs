### Wappalyzer Technology Detection (tech-detect:google-font-api) found on http://192.168.198.188
---
**Details**: **tech-detect:google-font-api**  matched at http://192.168.198.188

**Protocol**: HTTP

**Full URL**: http://192.168.198.188

**Timestamp**: Tue Jun 7 21:47:55 +0100 BST 2022
...
Date: Tue, 07 Jun 2022 20:47:54 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.47 Safari/537.36' 'http://192.168.198.188'
```
---
