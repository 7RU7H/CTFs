### Apache Detection (apache-detect) found on http://192.168.198.188
---
**Details**: **apache-detect**  matched at http://192.168.198.188

**Protocol**: HTTP

**Full URL**: http://192.168.198.188

**Timestamp**: Tue Jun 7 21:47:54 +0100 BST 2022
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2656.18 Safari/537.36' 'http://192.168.198.188'
```
---
