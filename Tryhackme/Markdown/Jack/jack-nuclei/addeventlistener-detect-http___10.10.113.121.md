### DOM EventListener detection (addeventlistener-detect) found on http://10.10.113.121
---
**Details**: **addeventlistener-detect**  matched at http://10.10.113.121

**Protocol**: HTTP

**Full URL**: http://10.10.113.121

**Timestamp**: Thu May 5 18:00:21 +0100 BST 2022
...
Date: Thu, 05 May 2022 17:00:20 GMT
...
**CURL Command**
```
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.77 Safari/537.36' 'http://10.10.113.121'
```
---
