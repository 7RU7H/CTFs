### WAF Detection (waf-detect:apachegeneric) found on http://10.10.113.121
---
**Details**: **waf-detect:apachegeneric**  matched at http://10.10.113.121

**Protocol**: HTTP

**Full URL**: http://10.10.113.121/

**Timestamp**: Thu May 5 18:04:29 +0100 BST 2022
...
Date: Thu, 05 May 2022 17:04:24 GMT
...
**CURL Command**
```
curl -X 'POST' -d '_=<script>alert(1)</script>' -H 'Content-Type: application/x-www-form-urlencoded' -H 'Host: 10.10.113.121' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1944.0 Safari/537.36' 'http://10.10.113.121/'
```
---
